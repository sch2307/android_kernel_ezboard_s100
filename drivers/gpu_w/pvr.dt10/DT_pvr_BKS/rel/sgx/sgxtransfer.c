#include	"DT_sgxtransfer.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
...
IMG_EXPORT PVRSRV_ERROR SGXSubmitTransferKM(IMG_HANDLE hDevHandle, PVRSRV_TRANSFER_SGX_KICK *psKick)
{
	...
	
	{
		...
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_0)
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "SGXSubmitTransferKM: Invalid CCB offset"));
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_2)
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_3)
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_4)
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_5)
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_6)
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_7)
		for (loop=0; loop<psKick->ui32NumSrcSync; loop++)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_8)
		...
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_9)
		...
		for (loop=0; loop<psKick->ui32NumSrcSync; loop++)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_10)
			psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->ahSrcSyncInfo[loop];
			psSyncInfo->psSyncData->ui32ReadOpsPending++;
		}
		for (loop=0; loop<psKick->ui32NumDstSync; loop++)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_11)
			psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->ahDstSyncInfo[loop];
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_12)
		...
		if ((psKick->ui32Flags & SGXMKIF_TQFLAGS_KEEPPENDING) == 0UL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_13)
			for (loop=0; loop<psKick->ui32NumSrcSync ; loop++)
			{
				__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_14)
		...
		if ((psKick->ui32Flags & SGXMKIF_TQFLAGS_KEEPPENDING) == 0UL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_15)
			for (loop=0; loop< psKick->ui32NumDstSync; loop++)
			{
				__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_16)
		...
		if((psKick->ui32Flags & SGXMKIF_TQFLAGS_KEEPPENDING)== 0UL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_17)
			for (loop=0; loop<(psKick->ui32NumSrcSync); loop++)
			{
				__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_18)
				psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->ahSrcSyncInfo[loop];
		...
		if((psKick->ui32Flags & SGXMKIF_TQFLAGS_KEEPPENDING) == 0UL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_19)
			for (loop=0; loop<(psKick->ui32NumDstSync); loop++)
			{
				__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_20)
	...
	if (eError == PVRSRV_ERROR_RETRY)
	{
		...
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_21)
		if ((psKick->ui32Flags & SGXMKIF_TQFLAGS_KEEPPENDING) == 0UL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_22)
			if (psKick->ui32NumSrcSync > 0)
			{
				__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_23)
				psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->ahSrcSyncInfo[0];
				psSyncInfo->psSyncData->ui32ReadOpsPending--;
			}
			if (psKick->ui32NumDstSync > 0)
			{
				__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_24)
				psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->ahDstSyncInfo[0];
				psSyncInfo->psSyncData->ui32WriteOpsPending--;
			}
#if defined(PDUMP)
			...
			|| ((psKick->ui32PDumpFlags & PDUMP_FLAGS_CONTINUOUS) != 0))
			{
				__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_25)
				if (psKick->ui32NumSrcSync > 0)
				{
					__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_26)
					psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->ahSrcSyncInfo[0];
					psSyncInfo->psSyncData->ui32LastReadOpDumpVal--;
				}
				if (psKick->ui32NumDstSync > 0)
				{
					__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_27)
					psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->ahDstSyncInfo[0];
					psSyncInfo->psSyncData->ui32LastOpDumpVal--;
				}
			}
		...
		if (psKick->hTASyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_28)
			psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->hTASyncInfo;
			psSyncInfo->psSyncData->ui32WriteOpsPending--;
		}
		...
		if (psKick->h3DSyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_29)
			psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->h3DSyncInfo;
			psSyncInfo->psSyncData->ui32WriteOpsPending--;
		}
	}
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_30)
		PVR_DPF((PVR_DBG_ERROR, "SGXSubmitTransferKM: SGXScheduleCCBCommandKM failed."));
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_31)
		return eError;
	}
	...
	if ((psKick->ui32Flags & SGXMKIF_TQFLAGS_NOSYNCUPDATE) == 0)
	{
		...
		__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_32)
		for(i = 0; i < psKick->ui32NumSrcSync; i++)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_33)
		...
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_34)
		...
		if (psKick->hTASyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_35)
			psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->hTASyncInfo;
		...
		if (psKick->h3DSyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmitTransferKM, __DtStep_36)
			psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->h3DSyncInfo;
					    ...
					    
{
	...
	
	{
		...
		if(psPerProc != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_0)
			bPersistentProcess = psPerProc->bPDumpPersistent;
		}
	}
#endif 
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "SGXSubmit2DKM: Invalid CCB offset"));
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_2)
		return PVRSRV_ERROR_INVALID_PARAMS;
	}
	...
	if (psKick->hTASyncInfo != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_3)
		psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->hTASyncInfo;
	...
	if (psKick->h3DSyncInfo != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_4)
		psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->h3DSyncInfo;
	...
	for (i = 0; i < psKick->ui32NumSrcSync; i++)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_5)
	...
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_6)
	...
	for (i = 0; i < psKick->ui32NumSrcSync; i++)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_7)
		psSyncInfo = psKick->ahSrcSyncInfo[i];
		psSyncInfo->psSyncData->ui32ReadOpsPending++;
	}
	...
	if (psKick->hDstSyncInfo != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_8)
		psSyncInfo = psKick->hDstSyncInfo;
		psSyncInfo->psSyncData->ui32WriteOpsPending++;
	}
	...
	&&  (bPersistentProcess == IMG_FALSE) )
	{
		...
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_9)
		...
		for (i = 0; i < psKick->ui32NumSrcSync; i++)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_10)
			psSyncInfo = psKick->ahSrcSyncInfo[i];
		...
		if (psKick->hDstSyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_11)
			psSyncInfo = psKick->hDstSyncInfo;
		...
		for (i = 0; i < psKick->ui32NumSrcSync; i++)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_12)
			psSyncInfo = psKick->ahSrcSyncInfo[i];
			psSyncInfo->psSyncData->ui32LastReadOpDumpVal++;
		}
		...
		if (psKick->hDstSyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_13)
			psSyncInfo = psKick->hDstSyncInfo;
			psSyncInfo->psSyncData->ui32LastOpDumpVal++;
		}
	}		
	...
	if (eError == PVRSRV_ERROR_RETRY)
	{
		...
		if (PDumpIsCaptureFrameKM())
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_14)
			for (i = 0; i < psKick->ui32NumSrcSync; i++)
			{
				__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_15)
				psSyncInfo = psKick->ahSrcSyncInfo[i];
				psSyncInfo->psSyncData->ui32LastReadOpDumpVal--;
			}
			...
			if (psKick->hDstSyncInfo != IMG_NULL)
			{
				__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_16)
				psSyncInfo = psKick->hDstSyncInfo;
				psSyncInfo->psSyncData->ui32LastOpDumpVal--;
			}
		}
		...
		for (i = 0; i < psKick->ui32NumSrcSync; i++)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_17)
			psSyncInfo = psKick->ahSrcSyncInfo[i];
			psSyncInfo->psSyncData->ui32ReadOpsPending--;
		}
		...
		if (psKick->hDstSyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_18)
			psSyncInfo = psKick->hDstSyncInfo;
			psSyncInfo->psSyncData->ui32WriteOpsPending--;
		}
		...
		if (psKick->hTASyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_19)
			psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->hTASyncInfo;
		...
		if (psKick->h3DSyncInfo != IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_20)
			psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->h3DSyncInfo;
	...
	for(i = 0; i < psKick->ui32NumSrcSync; i++)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_21)
		psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->ahSrcSyncInfo[i];
		psSyncInfo->psSyncData->ui32ReadOpsComplete = psSyncInfo->psSyncData->ui32ReadOpsPending;
	}
	...
	if (psKick->hDstSyncInfo != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_22)
	...
	if (psKick->hTASyncInfo != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_23)
		psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->hTASyncInfo;
	...
	if (psKick->h3DSyncInfo != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXSubmit2DKM, __DtStep_24)
		psSyncInfo = (PVRSRV_KERNEL_SYNC_INFO *)psKick->h3DSyncInfo;
