#include	"DT_event.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
...
PVRSRV_ERROR LinuxEventObjectListCreate(IMG_HANDLE *phEventObjectList)
{
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectListCreate, __DtStep_0)
	...
	{
		__DtTestPoint(__DtFunc_LinuxEventObjectListCreate, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "LinuxEventObjectCreate: failed to allocate memory for event list"));		
		__DtTestPoint(__DtFunc_LinuxEventObjectListCreate, __DtStep_2)
	...
	*phEventObjectList = (IMG_HANDLE *) psEventObjectList;
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectListCreate, __DtStep_3)
	return PVRSRV_OK;
}
...
PVRSRV_ERROR LinuxEventObjectListDestroy(IMG_HANDLE hEventObjectList)
{
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectListDestroy, __DtStep_0)
	if(psEventObjectList)	
	{
		IMG_BOOL bListEmpty;

		__DtTestPoint(__DtFunc_LinuxEventObjectListDestroy, __DtStep_1)
		...
		if (!bListEmpty) 
		{
			 __DtTestPoint(__DtFunc_LinuxEventObjectListDestroy, __DtStep_2)
			 PVR_DPF((PVR_DBG_ERROR, "LinuxEventObjectListDestroy: Event List is not empty"));
			 __DtTestPoint(__DtFunc_LinuxEventObjectListDestroy, __DtStep_3)
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectListDestroy, __DtStep_4)
	return PVRSRV_OK;
}
...
{
	__DtTestPoint(__DtFunc_LinuxEventObjectDelete, __DtStep_0)
	if(hOSEventObjectList)
	{
		__DtTestPoint(__DtFunc_LinuxEventObjectDelete, __DtStep_1)
		if(hOSEventObject)
		{
			...
			{
				__DtTestPoint(__DtFunc_LinuxEventObjectDelete, __DtStep_2)
				return PVRSRV_ERROR_UNABLE_TO_DESTROY_EVENT;
			}
			
			__DtTestPoint(__DtFunc_LinuxEventObjectDelete, __DtStep_3)
			return PVRSRV_OK;
		}
	}
	__DtTestPoint(__DtFunc_LinuxEventObjectDelete, __DtStep_4)
	return PVRSRV_ERROR_UNABLE_TO_DESTROY_EVENT;
...
static PVRSRV_ERROR LinuxEventObjectDeleteCallback(IMG_PVOID pvParam, IMG_UINT32 ui32Param)
{
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectDeleteCallback, __DtStep_0)
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectDeleteCallback, __DtStep_1)
	return PVRSRV_OK;
}
PVRSRV_ERROR LinuxEventObjectAdd(IMG_HANDLE hOSEventObjectList, IMG_HANDLE *phOSEventObject)
 {
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectAdd, __DtStep_0)
	psPerProc = PVRSRVPerProcessData(ui32PID);
	if (psPerProc == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_LinuxEventObjectAdd, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "LinuxEventObjectAdd: Couldn't find per-process data"));
		__DtTestPoint(__DtFunc_LinuxEventObjectAdd, __DtStep_2)
		return PVRSRV_ERROR_OUT_OF_MEMORY;
	}
	...
	{
		__DtTestPoint(__DtFunc_LinuxEventObjectAdd, __DtStep_3)
		PVR_DPF((PVR_DBG_ERROR, "LinuxEventObjectAdd: failed to allocate memory "));		
		__DtTestPoint(__DtFunc_LinuxEventObjectAdd, __DtStep_4)
		return PVRSRV_ERROR_OUT_OF_MEMORY;	
	}
	...
	*phOSEventObject = psLinuxEventObject;
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectAdd, __DtStep_5)
	return PVRSRV_OK;	 
}
...
PVRSRV_ERROR LinuxEventObjectSignal(IMG_HANDLE hOSEventObjectList)
{
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectSignal, __DtStep_0)
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectSignal, __DtStep_1)
	return 	PVRSRV_OK;
...
PVRSRV_ERROR LinuxEventObjectWait(IMG_HANDLE hOSEventObject, IMG_UINT32 ui32MSTimeout)
{
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectWait, __DtStep_0)
	DEFINE_WAIT(sWait);
	...
	do	
	{
		__DtTestPoint(__DtFunc_LinuxEventObjectWait, __DtStep_1)
		prepare_to_wait(&psLinuxEventObject->sWait, &sWait, TASK_INTERRUPTIBLE);
		ui32TimeStamp = (IMG_UINT32)atomic_read(&psLinuxEventObject->sTimeStamp);
   	
		if(psLinuxEventObject->ui32TimeStampPrevious != ui32TimeStamp)
		{
			__DtTestPoint(__DtFunc_LinuxEventObjectWait, __DtStep_2)
			break;
		}
	...
	__DtTestPoint(__DtFunc_LinuxEventObjectWait, __DtStep_3)
