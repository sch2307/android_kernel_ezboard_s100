#include	"DT_ra.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
...
static IMG_CHAR *ReplaceSpaces(IMG_CHAR * const pS)
{
	...
	__DtTestPoint(__DtFunc_ReplaceSpaces, __DtStep_0)
	for(pT = pS; *pT != 0; pT++)
	{
		__DtTestPoint(__DtFunc_ReplaceSpaces, __DtStep_1)
		if (*pT == ' ' || *pT == '\t')
		{
			__DtTestPoint(__DtFunc_ReplaceSpaces, __DtStep_2)
			*pT = '_';
		}
	}

	__DtTestPoint(__DtFunc_ReplaceSpaces, __DtStep_3)
	return pS;
}
#endif
...
{
	__DtTestPoint(__DtFunc__RequestAllocFail, __DtStep_0)
	...
	__DtTestPoint(__DtFunc__RequestAllocFail, __DtStep_1)
	return IMG_FALSE;
}
...
{
	IMG_UINT32 l = 0;
	__DtTestPoint(__DtFunc_pvr_log2, __DtStep_0)
	n>>=1;
	while (n>0)
	{
		__DtTestPoint(__DtFunc_pvr_log2, __DtStep_1)
		n>>=1;
		l++;
	}
	__DtTestPoint(__DtFunc_pvr_log2, __DtStep_2)
	return l;
}
...
_SegmentListInsertAfter (RA_ARENA *pArena,
						 ...
						 BT *pBT)
{
	__DtTestPoint(__DtFunc__SegmentListInsertAfter, __DtStep_0)
	PVR_ASSERT (pArena != IMG_NULL);
	PVR_ASSERT (pInsertionPoint != IMG_NULL);

	if ((pInsertionPoint == IMG_NULL) || (pArena == IMG_NULL))
	{
		__DtTestPoint(__DtFunc__SegmentListInsertAfter, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"_SegmentListInsertAfter: invalid parameters"));
		__DtTestPoint(__DtFunc__SegmentListInsertAfter, __DtStep_2)
	...
	__DtTestPoint(__DtFunc__SegmentListInsertAfter, __DtStep_3)
	return PVRSRV_OK;
}
...
_SegmentListInsert (RA_ARENA *pArena, BT *pBT)
{
	...
	__DtTestPoint(__DtFunc__SegmentListInsert, __DtStep_0)
	if (pArena->pHeadSegment == IMG_NULL)
	{
		__DtTestPoint(__DtFunc__SegmentListInsert, __DtStep_1)
	...
	else
	{
		...
		__DtTestPoint(__DtFunc__SegmentListInsert, __DtStep_2)
		if (pBT->base < pArena->pHeadSegment->base)
		{
			
			__DtTestPoint(__DtFunc__SegmentListInsert, __DtStep_3)
		...
		else
		{
			...
			__DtTestPoint(__DtFunc__SegmentListInsert, __DtStep_4)
			pBTScan = pArena->pHeadSegment;

			while ((pBTScan->pNextSegment != IMG_NULL)  && (pBT->base >= pBTScan->pNextSegment->base))
			{
				__DtTestPoint(__DtFunc__SegmentListInsert, __DtStep_5)
			...
			if (eError != PVRSRV_OK)
			{
				__DtTestPoint(__DtFunc__SegmentListInsert, __DtStep_6)
				return eError;
			}
		}
	}
	__DtTestPoint(__DtFunc__SegmentListInsert, __DtStep_7)
	return eError;
}
...
{
	__DtTestPoint(__DtFunc__SegmentListRemove, __DtStep_0)
	...
	__DtTestPoint(__DtFunc__SegmentListRemove, __DtStep_1)
}
...
_SegmentSplit (RA_ARENA *pArena, BT *pBT, IMG_SIZE_T uSize)
{
	...
	__DtTestPoint(__DtFunc__SegmentSplit, __DtStep_0)
	PVR_ASSERT (pArena != IMG_NULL);

	if (pArena == IMG_NULL)
	{
		__DtTestPoint(__DtFunc__SegmentSplit, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"_SegmentSplit: invalid parameter - pArena"));
		__DtTestPoint(__DtFunc__SegmentSplit, __DtStep_2)
		return IMG_NULL;
	}
	...
	{
		__DtTestPoint(__DtFunc__SegmentSplit, __DtStep_3)
		return IMG_NULL;
	}
	...
	{
		__DtTestPoint(__DtFunc__SegmentSplit, __DtStep_4)
	...
	{
		__DtTestPoint(__DtFunc__SegmentSplit, __DtStep_5)
		pNeighbour->eResourceType = NON_IMPORTED_RESOURCE_TYPE;
		pNeighbour->eResourceSpan = RESOURCE_SPAN_FREE;
	}
	else
	{
		__DtTestPoint(__DtFunc__SegmentSplit, __DtStep_6)
...
{
	IMG_UINT32 uIndex;
	__DtTestPoint(__DtFunc__FreeListInsert, __DtStep_0)
	...
	__DtTestPoint(__DtFunc__FreeListInsert, __DtStep_1)
}
...
{
	IMG_UINT32 uIndex;
	__DtTestPoint(__DtFunc__FreeListRemove, __DtStep_0)
	uIndex = pvr_log2 (pBT->uSize);
	...
	__DtTestPoint(__DtFunc__FreeListRemove, __DtStep_1)
}
...
_BuildSpanMarker (IMG_UINTPTR_T base, IMG_SIZE_T uSize)
{
	...
	__DtTestPoint(__DtFunc__BuildSpanMarker, __DtStep_0)
	if(OSAllocMem(PVRSRV_OS_PAGEABLE_HEAP,
					sizeof(BT),
					(IMG_VOID **)&pBT, IMG_NULL,
					"Boundary Tag") != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc__BuildSpanMarker, __DtStep_1)
		return IMG_NULL;
	}
	...
	__DtTestPoint(__DtFunc__BuildSpanMarker, __DtStep_2)
	return pBT;
}
...
_BuildBT (IMG_UINTPTR_T base, IMG_SIZE_T uSize)
{
	...
	__DtTestPoint(__DtFunc__BuildBT, __DtStep_0)
	if(OSAllocMem(PVRSRV_OS_PAGEABLE_HEAP,
					sizeof(BT),
					(IMG_VOID **)&pBT, IMG_NULL,
					"Boundary Tag") != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc__BuildBT, __DtStep_1)
		return IMG_NULL;
	}
	...
	__DtTestPoint(__DtFunc__BuildBT, __DtStep_2)
	return pBT;
}
...
{
	BT *pBT;
	__DtTestPoint(__DtFunc__InsertResource, __DtStep_0)
	PVR_ASSERT (pArena!=IMG_NULL);
	if (pArena == IMG_NULL)
	{
		__DtTestPoint(__DtFunc__InsertResource, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"_InsertResource: invalid parameter - pArena"));
		__DtTestPoint(__DtFunc__InsertResource, __DtStep_2)
		return IMG_NULL;
	}
	...
	if (pBT != IMG_NULL)
	{
		...
		{
			__DtTestPoint(__DtFunc__InsertResource, __DtStep_3)
			PVR_DPF ((PVR_DBG_ERROR,"_InsertResource: call to _SegmentListInsert failed"));
			__DtTestPoint(__DtFunc__InsertResource, __DtStep_4)
			return IMG_NULL;
		}
	...
	__DtTestPoint(__DtFunc__InsertResource, __DtStep_5)
	return pBT;
}
...
_InsertResourceSpan (RA_ARENA *pArena, IMG_UINTPTR_T base, IMG_SIZE_T uSize)
{
	...
	__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_0)
	PVR_ASSERT (pArena != IMG_NULL);
	if (pArena == IMG_NULL)
	{
		__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"_InsertResourceSpan: invalid parameter - pArena"));
		__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_2)
		return IMG_NULL;
	}
	...
	{
		__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_3)
		goto fail_start;
	}
	...
	{
		__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_4)
		goto fail_end;
	}
	...
	if (pBT == IMG_NULL)
	{
		__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_5)
		goto fail_bt;
	}
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_6)
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_7)
		goto fail_SegListInsert;
	}
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_8)
		goto fail_SegListInsert;
	}
  ...
  fail_start:
	__DtTestPoint(__DtFunc__InsertResourceSpan, __DtStep_9)
	return IMG_NULL;
}
...
_FreeBT (RA_ARENA *pArena, BT *pBT, IMG_BOOL bFreeBackingStore)
{
	...
	__DtTestPoint(__DtFunc__FreeBT, __DtStep_0)
	PVR_ASSERT (pArena!=IMG_NULL);
	PVR_ASSERT (pBT!=IMG_NULL);

	if ((pArena == IMG_NULL) || (pBT == IMG_NULL))
	{
		__DtTestPoint(__DtFunc__FreeBT, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"_FreeBT: invalid parameter"));
		__DtTestPoint(__DtFunc__FreeBT, __DtStep_2)
		return;
	}
	...
	{
		__DtTestPoint(__DtFunc__FreeBT, __DtStep_3)
	...
	{
		__DtTestPoint(__DtFunc__FreeBT, __DtStep_4)
		_FreeListRemove (pArena, pNeighbour);
		_SegmentListRemove (pArena, pNeighbour);
		pBT->uSize += pNeighbour->uSize;
		OSFreeMem(PVRSRV_OS_PAGEABLE_HEAP, sizeof(BT), pNeighbour, IMG_NULL);
	...
	if (pArena->pBackingStoreFree != IMG_NULL && bFreeBackingStore)
	{
		...
		__DtTestPoint(__DtFunc__FreeBT, __DtStep_5)
		uRoundedStart = (uOrigBase / pArena->uQuantum) * pArena->uQuantum;
		
		if (uRoundedStart < pBT->base)
		{
			__DtTestPoint(__DtFunc__FreeBT, __DtStep_6)
		...
		{
			__DtTestPoint(__DtFunc__FreeBT, __DtStep_7)
			uRoundedEnd -= pArena->uQuantum;
		}

		if (uRoundedStart < uRoundedEnd)
		{
			__DtTestPoint(__DtFunc__FreeBT, __DtStep_8)
		...
		&& pBT->pPrevSegment!=IMG_NULL && pBT->pPrevSegment->type == btt_span)
	{
		...
		__DtTestPoint(__DtFunc__FreeBT, __DtStep_9)
		...
		_FreeListInsert (pArena, pBT);
	__DtTestPoint(__DtFunc__FreeBT, __DtStep_10)
}
...
{
	IMG_UINT32 uIndex;
	__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_0)
	PVR_ASSERT (pArena!=IMG_NULL);
	if (pArena == IMG_NULL)
	{
		__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"_AttemptAllocAligned: invalid parameter - pArena"));
		__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_2)
		return IMG_FALSE;
	}
	...
	{
		__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_3)
		if (pArena->aHeadFree[uIndex]!=IMG_NULL)
		{
			
			BT *pBT;

			__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_4)
			pBT = pArena->aHeadFree [uIndex];
			while (pBT!=IMG_NULL)
			{
				IMG_UINTPTR_T aligned_base;

				__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_5)
				if (uAlignment>1)
				...
				{
					__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_6)
					if(!pBT->psMapping || pBT->psMapping->ui32Flags == uFlags)
					{
						__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_7)
						...
						{
							BT *pNeighbour;
							__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_8)
							pNeighbour = _SegmentSplit (pArena, pBT, (IMG_SIZE_T)(aligned_base - pBT->base));
							
							if (pNeighbour==IMG_NULL)
							{
								__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_9)
								PVR_DPF ((PVR_DBG_ERROR,"_AttemptAllocAligned: Front split failed"));
								
								_FreeListInsert (pArena, pBT);
								__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_10)
								return IMG_FALSE;
							}
						...
						{
							BT *pNeighbour;
							__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_11)
							pNeighbour = _SegmentSplit (pArena, pBT, uSize);
							
							if (pNeighbour==IMG_NULL)
							{
								__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_12)
								PVR_DPF ((PVR_DBG_ERROR,"_AttemptAllocAligned: Back split failed"));
								
								_FreeListInsert (pArena, pBT);
								__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_13)
								return IMG_FALSE;
							}
						...
						{
							__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_14)
							pBT->eResourceSpan = IMPORTED_RESOURCE_SPAN_LIVE;
						}
						else if (pBT->eResourceType == NON_IMPORTED_RESOURCE_TYPE)
						{
							__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_15)
							pBT->eResourceSpan = RESOURCE_SPAN_LIVE;
						}
						else
						{
							__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_16)
						...
						{
							__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_17)
							_FreeBT (pArena, pBT, IMG_FALSE);
							__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_18)
							return IMG_FALSE;
						}
						...
						*base = pBT->base;
						...
						__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_19)
						return IMG_TRUE;
					}
					else
					{
						__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_20)
						PVR_DPF ((PVR_DBG_MESSAGE,
	...
	__DtTestPoint(__DtFunc__AttemptAllocAligned, __DtStep_21)
	return IMG_FALSE;
}
		   ...
		   IMG_VOID *pImportHandle)
{
	...
	__DtTestPoint(__DtFunc_RA_Create, __DtStep_0)
	PVR_DPF ((PVR_DBG_MESSAGE,
	...
	{
		__DtTestPoint(__DtFunc_RA_Create, __DtStep_1)
		goto arena_fail;
	}
	...
	if(strcmp(pArena->name,"") != 0)
	{
		...
		__DtTestPoint(__DtFunc_RA_Create, __DtStep_2)
		...
		{
			__DtTestPoint(__DtFunc_RA_Create, __DtStep_3)
		...
		{
			__DtTestPoint(__DtFunc_RA_Create, __DtStep_4)
			pArena->pProcInfo = 0;
		...
		if (ret > 0 && ret < sizeof(szProcInfoName))
		{
			__DtTestPoint(__DtFunc_RA_Create, __DtStep_5)
		...
		{
			__DtTestPoint(__DtFunc_RA_Create, __DtStep_6)
			pArena->pProcSegs = 0;
	...
	{
		__DtTestPoint(__DtFunc_RA_Create, __DtStep_7)
		goto hash_fail;
	}
	if (uSize>0)
	{
		__DtTestPoint(__DtFunc_RA_Create, __DtStep_8)
		uSize = (uSize + uQuantum - 1) / uQuantum * uQuantum;
		pBT = _InsertResource (pArena, base, uSize);
		if (pBT == IMG_NULL)
		{
			__DtTestPoint(__DtFunc_RA_Create, __DtStep_9)
			goto insert_fail;
		}
		pBT->psMapping = psMapping;

	}
	__DtTestPoint(__DtFunc_RA_Create, __DtStep_10)
	return pArena;
...
arena_fail:
	__DtTestPoint(__DtFunc_RA_Create, __DtStep_11)
	return IMG_NULL;
}
...
RA_Delete (RA_ARENA *pArena)
{
	...
	__DtTestPoint(__DtFunc_RA_Delete, __DtStep_0)
	PVR_ASSERT(pArena != IMG_NULL);

	if (pArena == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_RA_Delete, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"RA_Delete: invalid parameter - pArena"));
		__DtTestPoint(__DtFunc_RA_Delete, __DtStep_2)
		return;
	}
	...
	while (pArena->pHeadSegment != IMG_NULL)
	{
		...
		__DtTestPoint(__DtFunc_RA_Delete, __DtStep_3)
		if (pBT->type != btt_free)
		{
			__DtTestPoint(__DtFunc_RA_Delete, __DtStep_4)
...
#if defined(CONFIG_PROC_FS) && defined(DEBUG)
	{
		...
		{
			__DtTestPoint(__DtFunc_RA_Delete, __DtStep_5)
			pfnRemoveProcEntrySeq( pArena->pProcInfo );
		}

		if (pArena->pProcSegs != 0)
		{
			__DtTestPoint(__DtFunc_RA_Delete, __DtStep_6)
	...
	__DtTestPoint(__DtFunc_RA_Delete, __DtStep_7)
}

IMG_BOOL
RA_TestDelete (RA_ARENA *pArena)
{
	__DtTestPoint(__DtFunc_RA_TestDelete, __DtStep_0)
	PVR_ASSERT(pArena != IMG_NULL);

	if (pArena != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_RA_TestDelete, __DtStep_1)
		while (pArena->pHeadSegment != IMG_NULL)
		{
			BT *pBT = pArena->pHeadSegment;
			__DtTestPoint(__DtFunc_RA_TestDelete, __DtStep_2)
			if (pBT->type != btt_free)
			{
				__DtTestPoint(__DtFunc_RA_TestDelete, __DtStep_3)
				...
				__DtTestPoint(__DtFunc_RA_TestDelete, __DtStep_4)
				return IMG_FALSE;
			}
		}
	}

	__DtTestPoint(__DtFunc_RA_TestDelete, __DtStep_5)
	return IMG_TRUE;
}
...
{
	__DtTestPoint(__DtFunc_RA_Add, __DtStep_0)
	PVR_ASSERT (pArena != IMG_NULL);

	if (pArena == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_RA_Add, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"RA_Add: invalid parameter - pArena"));
		__DtTestPoint(__DtFunc_RA_Add, __DtStep_2)
		return IMG_FALSE;
	}
	...
	__DtTestPoint(__DtFunc_RA_Add, __DtStep_3)
		  ...
		  IMG_UINTPTR_T *base)
{
	...
	__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_0)
	PVR_ASSERT (pArena!=IMG_NULL);

	if (pArena == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"RA_Alloc: invalid parameter - pArena"));
		__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_2)
		return IMG_FALSE;
	}
	...
	{
		__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_3)
		*pActualSize = uSize;
	}
	...
	if (!bResult)
	{
		...
		__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_4)
		if (uAlignment > pArena->uQuantum)
		{
			__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_5)
		...
		{
			BT *pBT;
			__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_6)
			pBT = _InsertResourceSpan (pArena, import_base, uImportSize);
			
			if (pBT == IMG_NULL)
			{
				
				__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_7)
				...
				__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_8)
				return IMG_FALSE;
			}
			...
			if (!bResult)
			{
				__DtTestPoint(__DtFunc_RA_Alloc, __DtStep_9)
				PVR_DPF ((PVR_DBG_MESSAGE,
...
IMG_UINT32 ValidateArena(RA_ARENA *pArena)
{
	...
	__DtTestPoint(__DtFunc_ValidateArena, __DtStep_0)
	pSegment = pArena->pHeadSegment;

	if (pSegment == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_ValidateArena, __DtStep_1)
		return 0;
	}

	if (pSegment->eResourceType == IMPORTED_RESOURCE_TYPE)
	{
		__DtTestPoint(__DtFunc_ValidateArena, __DtStep_2)
		PVR_ASSERT(pSegment->eResourceSpan == IMPORTED_RESOURCE_SPAN_START);

		while (pSegment->pNextSegment)
		{
			__DtTestPoint(__DtFunc_ValidateArena, __DtStep_3)
			...
			switch (pSegment->eResourceSpan)
			{
				...
				case IMPORTED_RESOURCE_SPAN_FREE:
					...
					__DtTestPoint(__DtFunc_ValidateArena, __DtStep_6)
					if (!((eNextSpan == IMPORTED_RESOURCE_SPAN_LIVE) ||
						  (eNextSpan == IMPORTED_RESOURCE_SPAN_END)))
					{
						
						__DtTestPoint(__DtFunc_ValidateArena, __DtStep_7)
						PVR_DPF((PVR_DBG_ERROR, "ValidateArena ERROR: adjacent boundary tags %d (base=0x%x) and %d (base=0x%x) are incompatible (arena: %s)",
								pSegment->ui32BoundaryTagID, pSegment->base, pSegment->pNextSegment->ui32BoundaryTagID, pSegment->pNextSegment->base, pArena->name));
				...
				case IMPORTED_RESOURCE_SPAN_END:
					...
					__DtTestPoint(__DtFunc_ValidateArena, __DtStep_8)
					if ((eNextSpan == IMPORTED_RESOURCE_SPAN_LIVE) ||
						(eNextSpan == IMPORTED_RESOURCE_SPAN_FREE) ||
						(eNextSpan == IMPORTED_RESOURCE_SPAN_END))
					{
						
						__DtTestPoint(__DtFunc_ValidateArena, __DtStep_9)
						PVR_DPF((PVR_DBG_ERROR, "ValidateArena ERROR: adjacent boundary tags %d (base=0x%x) and %d (base=0x%x) are incompatible (arena: %s)",
								pSegment->ui32BoundaryTagID, pSegment->base, pSegment->pNextSegment->ui32BoundaryTagID, pSegment->pNextSegment->base, pArena->name));
				...
				case IMPORTED_RESOURCE_SPAN_START:
					...
					__DtTestPoint(__DtFunc_ValidateArena, __DtStep_10)
					if (!((eNextSpan == IMPORTED_RESOURCE_SPAN_LIVE) ||
						  (eNextSpan == IMPORTED_RESOURCE_SPAN_FREE)))
					{
						
						__DtTestPoint(__DtFunc_ValidateArena, __DtStep_11)
						PVR_DPF((PVR_DBG_ERROR, "ValidateArena ERROR: adjacent boundary tags %d (base=0x%x) and %d (base=0x%x) are incompatible (arena: %s)",
								pSegment->ui32BoundaryTagID, pSegment->base, pSegment->pNextSegment->ui32BoundaryTagID, pSegment->pNextSegment->base, pArena->name));
				...
				default:
					__DtTestPoint(__DtFunc_ValidateArena, __DtStep_12)
					PVR_DPF((PVR_DBG_ERROR, "ValidateArena ERROR: adjacent boundary tags %d (base=0x%x) and %d (base=0x%x) are incompatible (arena: %s)",
								pSegment->ui32BoundaryTagID, pSegment->base, pSegment->pNextSegment->ui32BoundaryTagID, pSegment->pNextSegment->base, pArena->name));
	...
	{
		__DtTestPoint(__DtFunc_ValidateArena, __DtStep_13)
		PVR_ASSERT((pSegment->eResourceSpan == RESOURCE_SPAN_FREE) || (pSegment->eResourceSpan == RESOURCE_SPAN_LIVE));

		while (pSegment->pNextSegment)
		{
			__DtTestPoint(__DtFunc_ValidateArena, __DtStep_14)
			eNextSpan = pSegment->pNextSegment->eResourceSpan;
			...
			switch (pSegment->eResourceSpan)
			{
				case RESOURCE_SPAN_LIVE:
					...
					__DtTestPoint(__DtFunc_ValidateArena, __DtStep_15)
					if (!((eNextSpan == RESOURCE_SPAN_FREE) ||
						  (eNextSpan == RESOURCE_SPAN_LIVE)))
					{
						
						__DtTestPoint(__DtFunc_ValidateArena, __DtStep_16)
						PVR_DPF((PVR_DBG_ERROR, "ValidateArena ERROR: adjacent boundary tags %d (base=0x%x) and %d (base=0x%x) are incompatible (arena: %s)",
								pSegment->ui32BoundaryTagID, pSegment->base, pSegment->pNextSegment->ui32BoundaryTagID, pSegment->pNextSegment->base, pArena->name));
				...
				case RESOURCE_SPAN_FREE:
					...
					__DtTestPoint(__DtFunc_ValidateArena, __DtStep_17)
					if (!((eNextSpan == RESOURCE_SPAN_FREE) ||
						  (eNextSpan == RESOURCE_SPAN_LIVE)))
					{
						
						__DtTestPoint(__DtFunc_ValidateArena, __DtStep_18)
						PVR_DPF((PVR_DBG_ERROR, "ValidateArena ERROR: adjacent boundary tags %d (base=0x%x) and %d (base=0x%x) are incompatible (arena: %s)",
								pSegment->ui32BoundaryTagID, pSegment->base, pSegment->pNextSegment->ui32BoundaryTagID, pSegment->pNextSegment->base, pArena->name));
				...
				default:
					__DtTestPoint(__DtFunc_ValidateArena, __DtStep_19)
					PVR_DPF((PVR_DBG_ERROR, "ValidateArena ERROR: adjacent boundary tags %d (base=0x%x) and %d (base=0x%x) are incompatible (arena: %s)",
								pSegment->ui32BoundaryTagID, pSegment->base, pSegment->pNextSegment->ui32BoundaryTagID, pSegment->pNextSegment->base, pArena->name));
	...
	{
		__DtTestPoint(__DtFunc_ValidateArena, __DtStep_20)
		PVR_DPF ((PVR_DBG_ERROR,"ValidateArena ERROR: pSegment->eResourceType unrecognized"));

		PVR_DBG_BREAK;
	}

	__DtTestPoint(__DtFunc_ValidateArena, __DtStep_21)
	return 0;
}
...
RA_Free (RA_ARENA *pArena, IMG_UINTPTR_T base, IMG_BOOL bFreeBackingStore)
{
	...
	__DtTestPoint(__DtFunc_RA_Free, __DtStep_0)
	PVR_ASSERT (pArena != IMG_NULL);

	if (pArena == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_RA_Free, __DtStep_1)
		PVR_DPF ((PVR_DBG_ERROR,"RA_Free: invalid parameter - pArena"));
		__DtTestPoint(__DtFunc_RA_Free, __DtStep_2)
		return;
	}
	...
	if (pBT)
	{
		__DtTestPoint(__DtFunc_RA_Free, __DtStep_3)
...
#ifdef USE_BM_FREESPACE_CHECK
{
	...
	{
		__DtTestPoint(__DtFunc_RA_Free, __DtStep_4)
		*p++ = 0xAA;
	}
	while (p < (IMG_BYTE*)((IMG_UINT32)endp & 0xfffffffc))
	{
		__DtTestPoint(__DtFunc_RA_Free, __DtStep_5)
		*(IMG_UINT32*)p = 0xAAAAAAAA;
		p += sizeof(IMG_UINT32);
	}
	while (p < endp)
	{
		__DtTestPoint(__DtFunc_RA_Free, __DtStep_6)
		*p++ = 0xAA;
	}
	...
	__DtTestPoint(__DtFunc_RA_Free, __DtStep_7)
}
...
IMG_BOOL RA_GetNextLiveSegment(IMG_HANDLE hArena, RA_SEGMENT_DETAILS *psSegDetails)
{
	...
	__DtTestPoint(__DtFunc_RA_GetNextLiveSegment, __DtStep_0)
	if (psSegDetails->hSegment)
	{
		__DtTestPoint(__DtFunc_RA_GetNextLiveSegment, __DtStep_1)
	...
	else
	{
		...
		__DtTestPoint(__DtFunc_RA_GetNextLiveSegment, __DtStep_2)
		pBT = pArena->pHeadSegment;
	}
	
	while (pBT != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_RA_GetNextLiveSegment, __DtStep_3)
		if (pBT->type == btt_live)
		{
			__DtTestPoint(__DtFunc_RA_GetNextLiveSegment, __DtStep_4)
			psSegDetails->uiSize = pBT->uSize;
			psSegDetails->sCpuPhyAddr.uiAddr = pBT->base;
			psSegDetails->hSegment = (IMG_HANDLE)pBT->pNextSegment;

			__DtTestPoint(__DtFunc_RA_GetNextLiveSegment, __DtStep_5)
			return IMG_TRUE;
		}
	...
	__DtTestPoint(__DtFunc_RA_GetNextLiveSegment, __DtStep_6)
	return IMG_FALSE;
}
...
IMG_VOID CheckBMFreespace(IMG_VOID)
{
	...
	__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_0)
	if (pJFSavedArena != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_1)
		for (pBT=pJFSavedArena->pHeadSegment; pBT!=IMG_NULL; pBT=pBT->pNextSegment)
		{
			__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_2)
			if (pBT->type == btt_free)
			{
				__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_3)
				p = (IMG_BYTE*)pBT->base + SysGetDevicePhysOffset();
				endp = (IMG_BYTE*)((IMG_UINT32)(p + pBT->uSize) & 0xfffffffc);

				while ((IMG_UINT32)p & 3)
				{
					__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_4)
					if (*p++ != 0xAA)
					{
						__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_5)
				...
				while (p < endp)
				{
					__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_6)
					if (*(IMG_UINT32*)p != 0xAAAAAAAA)
					{
						__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_7)
						fprintf(stderr,"BM_FREESPACE_CHECK: Blank space at %08X has changed to 0x%x\n",p,*(IMG_UINT32*)p);
						for (;;);
						break;
					}
	...
	__DtTestPoint(__DtFunc_CheckBMFreespace, __DtStep_8)
}
#endif
...
{
	__DtTestPoint(__DtFunc__BTType, __DtStep_0)
	switch (eType)
	{
	case btt_span: 
		__DtTestPoint(__DtFunc__BTType, __DtStep_1)
		return "span";
	case btt_free: 
		__DtTestPoint(__DtFunc__BTType, __DtStep_2)
		return "free";
	case btt_live: 
		__DtTestPoint(__DtFunc__BTType, __DtStep_3)
		return "live";
	}
	__DtTestPoint(__DtFunc__BTType, __DtStep_4)
	return "junk";
}
#endif 
...
{
	BT *pBT;
	__DtTestPoint(__DtFunc_RA_Dump, __DtStep_0)
	PVR_ASSERT (pArena != IMG_NULL);
	...
	{
		__DtTestPoint(__DtFunc_RA_Dump, __DtStep_1)
...
#endif
	__DtTestPoint(__DtFunc_RA_Dump, __DtStep_2)
}
#endif 
...
static void RA_ProcSeqShowInfo(struct seq_file *sfile, void* el)
{
	...
	__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_0)
	switch (off)
	{
	case 1:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_1)
		seq_printf(sfile, "quantum\t\t\t%u\n", pArena->uQuantum);
		break;
	case 2:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_2)
		seq_printf(sfile, "import_handle\t\t%08X\n", (IMG_UINT)pArena->pImportHandle);
		break;
#ifdef RA_STATS
	case 3:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_3)
		seq_printf(sfile,"span count\t\t%u\n", pArena->sStatistics.uSpanCount);
		break;
	case 4:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_4)
		seq_printf(sfile, "live segment count\t%u\n", pArena->sStatistics.uLiveSegmentCount);
		break;
	case 5:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_5)
		seq_printf(sfile, "free segment count\t%u\n", pArena->sStatistics.uFreeSegmentCount);
		break;
	case 6:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_6)
		seq_printf(sfile, "free resource count\t%u (0x%x)\n",
							pArena->sStatistics.uFreeResourceCount,
							(IMG_UINT)pArena->sStatistics.uFreeResourceCount);
		break;
	case 7:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_7)
		seq_printf(sfile, "total allocs\t\t%u\n", pArena->sStatistics.uCumulativeAllocs);
		break;
	case 8:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_8)
		seq_printf(sfile, "total frees\t\t%u\n", pArena->sStatistics.uCumulativeFrees);
		break;
	case 9:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_9)
		seq_printf(sfile, "import count\t\t%u\n", pArena->sStatistics.uImportCount);
		break;
	case 10:
		__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_10)
		seq_printf(sfile, "export count\t\t%u\n", pArena->sStatistics.uExportCount);
		break;
#endif
	}

	__DtTestPoint(__DtFunc_RA_ProcSeqShowInfo, __DtStep_11)
}
...
static void* RA_ProcSeqOff2ElementInfo(struct seq_file * sfile, loff_t off)
{
	...
	__DtTestPoint(__DtFunc_RA_ProcSeqOff2ElementInfo, __DtStep_0)
	return 0;
}
...
static void RA_ProcSeqShowRegs(struct seq_file *sfile, void* el)
{
	...
	__DtTestPoint(__DtFunc_RA_ProcSeqShowRegs, __DtStep_0)
	if (el == PVR_PROC_SEQ_START_TOKEN)
	{
		__DtTestPoint(__DtFunc_RA_ProcSeqShowRegs, __DtStep_1)
		seq_printf(sfile, "Arena \"%s\"\nBase         Size Type Ref\n", pArena->name);
		__DtTestPoint(__DtFunc_RA_ProcSeqShowRegs, __DtStep_2)
		return;
	}

	if (pBT)
	{
		__DtTestPoint(__DtFunc_RA_ProcSeqShowRegs, __DtStep_3)
		seq_printf(sfile, "%08x %8x %4s %08x\n",
				   (IMG_UINT)pBT->base, (IMG_UINT)pBT->uSize, _BTType (pBT->type),
			       (IMG_UINT)pBT->psMapping);
	}
	__DtTestPoint(__DtFunc_RA_ProcSeqShowRegs, __DtStep_4)
}
...
static void* RA_ProcSeqOff2ElementRegs(struct seq_file * sfile, loff_t off)
{
	...
	__DtTestPoint(__DtFunc_RA_ProcSeqOff2ElementRegs, __DtStep_0)
	if(off == 0)
		return PVR_PROC_SEQ_START_TOKEN;

	for (pBT=pArena->pHeadSegment; --off && pBT; pBT=pBT->pNextSegment);

	__DtTestPoint(__DtFunc_RA_ProcSeqOff2ElementRegs, __DtStep_1)
	return (void*)pBT;
}
							...
							IMG_UINT32 *pui32StrLen)
{
	...
	__DtTestPoint(__DtFunc_RA_GetStats, __DtStep_0)
	...
	if (pArena->pHeadSegment != IMG_NULL &&
	    pArena->pHeadSegment->pPrevSegment != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_RA_GetStats, __DtStep_1)
		CHECK_SPACE(ui32StrLen);
	...
	if (pArena->pTailSegment != IMG_NULL &&
	    pArena->pTailSegment->pNextSegment != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_RA_GetStats, __DtStep_2)
		CHECK_SPACE(ui32StrLen);
	...
	for (pBT=pArena->pHeadSegment; pBT!=IMG_NULL; pBT=pBT->pNextSegment)
	{
		__DtTestPoint(__DtFunc_RA_GetStats, __DtStep_3)
		CHECK_SPACE(ui32StrLen);
	...
	*pui32StrLen = ui32StrLen;
	...
	__DtTestPoint(__DtFunc_RA_GetStats, __DtStep_4)
	return PVRSRV_OK;
}
								...
								IMG_UINT32 *pui32StrLen)
{
	...
	IMG_UINT32 	ui32StrLen = *pui32StrLen;
	IMG_INT32	i32Count;
	__DtTestPoint(__DtFunc_RA_GetStatsFreeMem, __DtStep_0)
	CHECK_SPACE(ui32StrLen);
	...
	*pui32StrLen = ui32StrLen;
	...
	__DtTestPoint(__DtFunc_RA_GetStatsFreeMem, __DtStep_1)
	return PVRSRV_OK;
}
#endif
