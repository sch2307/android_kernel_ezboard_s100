#include	"DT_metrics.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
...
{
	__DtTestPoint(__DtFunc_PVRSRVTimeNow, __DtStep_0)
	if (!pui32TimerRegister)
	{
		static IMG_BOOL bFirstTime = IMG_TRUE;

		__DtTestPoint(__DtFunc_PVRSRVTimeNow, __DtStep_1)
		if (bFirstTime)
		{
			__DtTestPoint(__DtFunc_PVRSRVTimeNow, __DtStep_2)
			PVR_DPF((PVR_DBG_ERROR,"PVRSRVTimeNow: No timer register set up"));

			bFirstTime = IMG_FALSE;
		}

		__DtTestPoint(__DtFunc_PVRSRVTimeNow, __DtStep_3)
		return 0;
	}
...
static IMG_UINT32 PVRSRVGetCPUFreq(IMG_VOID)
{
	...
	__DtTestPoint(__DtFunc_PVRSRVGetCPUFreq, __DtStep_0)
	...
	__DtTestPoint(__DtFunc_PVRSRVGetCPUFreq, __DtStep_1)
...
IMG_VOID PVRSRVSetupMetricTimers(IMG_VOID *pvDevInfo)
{
	...
	__DtTestPoint(__DtFunc_PVRSRVSetupMetricTimers, __DtStep_0)
	PVR_UNREFERENCED_PARAMETER(pvDevInfo);

	for(ui32Loop=0; ui32Loop < (PVRSRV_NUM_TIMERS); ui32Loop++)
	{
		__DtTestPoint(__DtFunc_PVRSRVSetupMetricTimers, __DtStep_1)
	...
	__DtTestPoint(__DtFunc_PVRSRVSetupMetricTimers, __DtStep_2)
}
...
IMG_VOID PVRSRVOutputMetricTotals(IMG_VOID)
{
	...
	__DtTestPoint(__DtFunc_PVRSRVOutputMetricTotals, __DtStep_0)
	ui32TicksPerMS = PVRSRVGetCPUFreq();

	if (!ui32TicksPerMS)
	{
		__DtTestPoint(__DtFunc_PVRSRVOutputMetricTotals, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR,"PVRSRVOutputMetricTotals: Failed to get CPU Freq"));
		__DtTestPoint(__DtFunc_PVRSRVOutputMetricTotals, __DtStep_2)
		return;
	}

	for(ui32Loop=0; ui32Loop < (PVRSRV_NUM_TIMERS); ui32Loop++)
	{
		__DtTestPoint(__DtFunc_PVRSRVOutputMetricTotals, __DtStep_3)
		if (asTimers[ui32Loop].ui32Count & 0x80000000L)
		{
			__DtTestPoint(__DtFunc_PVRSRVOutputMetricTotals, __DtStep_4)
...
#endif
	__DtTestPoint(__DtFunc_PVRSRVOutputMetricTotals, __DtStep_5)
}
