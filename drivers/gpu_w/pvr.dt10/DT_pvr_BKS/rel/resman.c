#include	"DT_resman.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
...
{
	__DtTestPoint(__DtFunc_ResManInit, __DtStep_0)
	if (gpsResList == IMG_NULL)
	{
		
		__DtTestPoint(__DtFunc_ResManInit, __DtStep_1)
		if (OSAllocMem(PVRSRV_OS_PAGEABLE_HEAP,
						sizeof(*gpsResList),
						(IMG_VOID **)&gpsResList, IMG_NULL,
						"Resource Manager List") != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_ResManInit, __DtStep_2)
	...
	__DtTestPoint(__DtFunc_ResManInit, __DtStep_3)
	return PVRSRV_OK;
}
...
{
	__DtTestPoint(__DtFunc_ResManDeInit, __DtStep_0)
	if (gpsResList != IMG_NULL)
	{
		
		__DtTestPoint(__DtFunc_ResManDeInit, __DtStep_1)
		OSFreeMem(PVRSRV_OS_PAGEABLE_HEAP, sizeof(*gpsResList), gpsResList, IMG_NULL);
		gpsResList = IMG_NULL;
	}
	__DtTestPoint(__DtFunc_ResManDeInit, __DtStep_2)
}
								 ...
								 PRESMAN_CONTEXT	*phResManContext)
{
	...
	__DtTestPoint(__DtFunc_PVRSRVResManConnect, __DtStep_0)
	ACQUIRE_SYNC_OBJ;
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_PVRSRVResManConnect, __DtStep_1)
		...
		__DtTestPoint(__DtFunc_PVRSRVResManConnect, __DtStep_2)
		return eError;
	}
	...
	*phResManContext = psResManContext;
	...
	__DtTestPoint(__DtFunc_PVRSRVResManConnect, __DtStep_3)
	return PVRSRV_OK;
}
								...
								IMG_BOOL		bKernelContext)
{
	...
	__DtTestPoint(__DtFunc_PVRSRVResManDisconnect, __DtStep_0)
	ACQUIRE_SYNC_OBJ;
	...
	if (!bKernelContext)
	{
		...
		__DtTestPoint(__DtFunc_PVRSRVResManDisconnect, __DtStep_1)
	...
	RELEASE_SYNC_OBJ;
	__DtTestPoint(__DtFunc_PVRSRVResManDisconnect, __DtStep_2)
}
							   ...
							   RESMAN_FREE_FN	pfnFreeResource)
{
	...
	{
		__DtTestPoint(__DtFunc_ResManRegisterRes, __DtStep_3)
		...
		__DtTestPoint(__DtFunc_ResManRegisterRes, __DtStep_4)
		return((PRESMAN_ITEM)IMG_NULL);
	}
	...
	__DtTestPoint(__DtFunc_ResManRegisterRes, __DtStep_5)
	return(psNewResItem);
}
...
PVRSRV_ERROR ResManFreeResByPtr(RESMAN_ITEM	*psResItem)
{
	...
	__DtTestPoint(__DtFunc_ResManFreeResByPtr, __DtStep_0)
	PVR_ASSERT(psResItem != IMG_NULL);

	if (psResItem == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_ResManFreeResByPtr, __DtStep_1)
		PVR_DPF((PVR_DBG_MESSAGE, "ResManFreeResByPtr: NULL ptr - nothing to do"));
		__DtTestPoint(__DtFunc_ResManFreeResByPtr, __DtStep_2)
		return PVRSRV_OK;
	}
	...
	__DtTestPoint(__DtFunc_ResManFreeResByPtr, __DtStep_3)
	return(eError);
}
									 ...
									 IMG_UINT32			ui32Param)
{
	...
	__DtTestPoint(__DtFunc_ResManFreeResByCriteria, __DtStep_0)
	PVR_ASSERT(psResManContext != IMG_NULL);
	...
	__DtTestPoint(__DtFunc_ResManFreeResByCriteria, __DtStep_1)
	return eError;
}
							 ...
							 PRESMAN_CONTEXT	psNewResManContext)
{
	...
	__DtTestPoint(__DtFunc_ResManDissociateRes, __DtStep_0)
	PVR_ASSERT(psResItem != IMG_NULL);

	if (psResItem == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_ResManDissociateRes, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "ResManDissociateRes: invalid parameter - psResItem"));
		PVR_DBG_BREAK;
		__DtTestPoint(__DtFunc_ResManDissociateRes, __DtStep_2)
	...
	if (psNewResManContext != IMG_NULL)
	{
		...
		__DtTestPoint(__DtFunc_ResManDissociateRes, __DtStep_3)
	...
	{
		__DtTestPoint(__DtFunc_ResManDissociateRes, __DtStep_4)
		eError = FreeResourceByPtr(psResItem, IMG_FALSE);
		if(eError != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_ResManDissociateRes, __DtStep_5)
			PVR_DPF((PVR_DBG_ERROR, "ResManDissociateRes: failed to free resource by pointer"));
			__DtTestPoint(__DtFunc_ResManDissociateRes, __DtStep_6)
			return eError;
		}
	}

	__DtTestPoint(__DtFunc_ResManDissociateRes, __DtStep_7)
	return eError;
}
...
static IMG_BOOL ResManFindResourceByPtr_AnyVaCb(RESMAN_ITEM *psCurItem, va_list va)
{
	...
	__DtTestPoint(__DtFunc_ResManFindResourceByPtr_AnyVaCb, __DtStep_0)
	psItem = va_arg(va, RESMAN_ITEM*);

	__DtTestPoint(__DtFunc_ResManFindResourceByPtr_AnyVaCb, __DtStep_1)
												  ...
												  RESMAN_ITEM		*psItem)
{
	...
	__DtTestPoint(__DtFunc_ResManFindResourceByPtr, __DtStep_0)
	PVR_ASSERT(psResManContext != IMG_NULL);
	PVR_ASSERT(psItem != IMG_NULL);

	if ((psItem == IMG_NULL) || (psResManContext == IMG_NULL))
	{
		__DtTestPoint(__DtFunc_ResManFindResourceByPtr, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "ResManFindResourceByPtr: invalid parameter"));
		PVR_DBG_BREAK;
		__DtTestPoint(__DtFunc_ResManFindResourceByPtr, __DtStep_2)
		return PVRSRV_ERROR_INVALID_PARAMS;
	}
	...
	if(List_RESMAN_ITEM_IMG_BOOL_Any_va(psResManContext->psResItemList,
										...
										psItem))
	{
		__DtTestPoint(__DtFunc_ResManFindResourceByPtr, __DtStep_3)
		eResult = PVRSRV_OK;
	}
	else
	{
		__DtTestPoint(__DtFunc_ResManFindResourceByPtr, __DtStep_4)
	...
	__DtTestPoint(__DtFunc_ResManFindResourceByPtr, __DtStep_5)
	return eResult;
}
									  ...
									  IMG_BOOL		bExecuteCallback)
{
	...
	__DtTestPoint(__DtFunc_FreeResourceByPtr, __DtStep_0)
	PVR_ASSERT(psItem != IMG_NULL);

	if (psItem == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_FreeResourceByPtr, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "FreeResourceByPtr: invalid parameter"));
		__DtTestPoint(__DtFunc_FreeResourceByPtr, __DtStep_2)
		return PVRSRV_ERROR_INVALID_PARAMS;
	}
	...
	if (bExecuteCallback)
	{
		__DtTestPoint(__DtFunc_FreeResourceByPtr, __DtStep_3)
		eError = psItem->pfnFreeResource(psItem->pvParam, psItem->ui32Param);
	 	if (eError != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_FreeResourceByPtr, __DtStep_4)
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_FreeResourceByPtr, __DtStep_5)
		PVR_DPF((PVR_DBG_ERROR, "FreeResourceByPtr: ERROR freeing resource list item memory"));
	}

	__DtTestPoint(__DtFunc_FreeResourceByPtr, __DtStep_6)
	return(eError);
}
...
static IMG_VOID* FreeResourceByCriteria_AnyVaCb(RESMAN_ITEM *psCurItem, va_list va)
{
	...
	__DtTestPoint(__DtFunc_FreeResourceByCriteria_AnyVaCb, __DtStep_0)
	...
	{
		__DtTestPoint(__DtFunc_FreeResourceByCriteria_AnyVaCb, __DtStep_1)
		return psCurItem;
	}
	else
	{
		__DtTestPoint(__DtFunc_FreeResourceByCriteria_AnyVaCb, __DtStep_2)
		return IMG_NULL;
	}
	__DtTestPoint(__DtFunc_FreeResourceByCriteria_AnyVaCb, __DtStep_3)
}
										   ...
										   IMG_BOOL			bExecuteCallback)
{
	...
	__DtTestPoint(__DtFunc_FreeResourceByCriteria, __DtStep_0)
	while((psCurItem = (PRESMAN_ITEM)
		  	...
		  	&& eError == PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_FreeResourceByCriteria, __DtStep_1)
		eError = FreeResourceByPtr(psCurItem, bExecuteCallback);
	}

	__DtTestPoint(__DtFunc_FreeResourceByCriteria, __DtStep_2)
	return eError;
}
...
static IMG_VOID ValidateResList(PRESMAN_LIST psResList)
{
	...
	__DtTestPoint(__DtFunc_ValidateResList, __DtStep_0)
	if (psResList == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_ValidateResList, __DtStep_1)
		PVR_DPF((PVR_DBG_MESSAGE, "ValidateResList: resman not initialised yet"));
		__DtTestPoint(__DtFunc_ValidateResList, __DtStep_2)
		return;
	}
	...
	while(psCurContext != IMG_NULL)
	{
		...
		__DtTestPoint(__DtFunc_ValidateResList, __DtStep_3)
		PVR_ASSERT(psCurContext->ui32Signature == RESMAN_SIGNATURE);
		if (psCurContext->ppsThis != ppsThisContext)
		{
			__DtTestPoint(__DtFunc_ValidateResList, __DtStep_4)
		...
		while(psCurItem != IMG_NULL)
		{
			...
			__DtTestPoint(__DtFunc_ValidateResList, __DtStep_5)
			PVR_ASSERT(psCurItem->ui32Signature == RESMAN_SIGNATURE);
			if (psCurItem->ppsThis != ppsThisItem)
			{
				__DtTestPoint(__DtFunc_ValidateResList, __DtStep_6)
				PVR_DPF((PVR_DBG_WARNING,
	...
	__DtTestPoint(__DtFunc_ValidateResList, __DtStep_7)
}
#endif 
