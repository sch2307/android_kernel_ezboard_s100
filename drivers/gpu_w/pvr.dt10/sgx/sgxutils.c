#include	"DT_sgxutils.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
										...
										IMG_UINT32           ui32CallerID)
{
	...
	__DtTestPoint(__DtFunc_SGXPostActivePowerEvent, __DtStep_0)
	...
	if ((psSGXHostCtl->ui32PowerStatus & PVRSRV_USSE_EDM_POWMAN_POWEROFF_RESTART_IMMEDIATE) != 0)
	{
		...
		__DtTestPoint(__DtFunc_SGXPostActivePowerEvent, __DtStep_1)
		if (ui32CallerID == ISR_ID)
		{
			__DtTestPoint(__DtFunc_SGXPostActivePowerEvent, __DtStep_2)
			psDeviceNode->bReProcessDeviceCommandComplete = IMG_TRUE;
		}
		else
		{
			__DtTestPoint(__DtFunc_SGXPostActivePowerEvent, __DtStep_3)
			SGXScheduleProcessQueuesKM(psDeviceNode);
		}
	}
	__DtTestPoint(__DtFunc_SGXPostActivePowerEvent, __DtStep_4)
}
								  ...
								  IMG_UINT32			ui32CallerID)
{
	...
	__DtTestPoint(__DtFunc_SGXTestActivePowerEvent, __DtStep_0)
		...
		((psSGXHostCtl->ui32InterruptClearFlags & PVRSRV_USSE_EDM_INTERRUPT_ACTIVE_POWER) == 0))
	{
		...
		__DtTestPoint(__DtFunc_SGXTestActivePowerEvent, __DtStep_1)
		...
		if (eError == PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_SGXTestActivePowerEvent, __DtStep_2)
		...
		if (eError == PVRSRV_ERROR_RETRY)
		{
			...
			__DtTestPoint(__DtFunc_SGXTestActivePowerEvent, __DtStep_3)
			psSGXHostCtl->ui32InterruptClearFlags &= ~PVRSRV_USSE_EDM_INTERRUPT_ACTIVE_POWER;
			eError = PVRSRV_OK;
		}
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXTestActivePowerEvent, __DtStep_4)
		PVR_DPF((PVR_DBG_ERROR, "SGXTestActivePowerEvent error:%u", eError));
	}
	__DtTestPoint(__DtFunc_SGXTestActivePowerEvent, __DtStep_5)
}
...
{
	__DtTestPoint(__DtFunc_SGXAcquireKernelCCBSlot, __DtStep_0)
	LOOP_UNTIL_TIMEOUT(MAX_HW_TIME_US)
	{
		if(((*psCCB->pui32WriteOffset + 1) & 255) != *psCCB->pui32ReadOffset)
		{
			__DtTestPoint(__DtFunc_SGXAcquireKernelCCBSlot, __DtStep_1)
	...
	__DtTestPoint(__DtFunc_SGXAcquireKernelCCBSlot, __DtStep_2)
	return IMG_NULL;
}
								   ...
								   IMG_BOOL			bLastInScene)
{
		 ...
		 ((psDevInfo->ui32CacheControl & (SGXMKIF_CC_INVAL_BIF_PT | SGXMKIF_CC_INVAL_BIF_PD)) != 0))
	{
		...
		if (eError != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_0)
			goto Exit;
		}
		...
		if(PollForValueKM(&psSGXHostCtl->ui32InvalStatus,
						  ...
						  IMG_FALSE) != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_1)
	...
	
	{
		...
		{
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_2)
	...
	if(!psSGXCommand)
	{
		__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_3)
	...
	*psSGXCommand = *psCommandData;
	...
	{
		__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_4)
	...
	if((eCmdType == SGXMKIF_CMD_TA) && bLastInScene)
	{
		...
		__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_5)
		SysAcquireData(&psSysData);

		if(psSysData->ePendingCacheOpType == PVRSRV_MISC_INFO_CPUCACHEOP_FLUSH)	
		{
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_6)
			OSFlushCPUCacheKM();
		}
		else if(psSysData->ePendingCacheOpType == PVRSRV_MISC_INFO_CPUCACHEOP_CLEAN)
		{
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_7)
			OSCleanCPUCacheKM();
		}
		...
		(bPersistentProcess == IMG_FALSE) )
	{
		...
		__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_8)
		...
		|| ((ui32PDumpFlags & PDUMP_FLAGS_CONTINUOUS) != 0))
		{
			...
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_9)
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_10)
		eError = PVRSRV_ERROR_TIMEOUT;
		goto Exit;
	}
#endif
	...
	*psKernelCCB->pui32WriteOffset = (*psKernelCCB->pui32WriteOffset + 1) & 255;
		...
		(bPersistentProcess == IMG_FALSE) )
	{
		...
		|| ((ui32PDumpFlags & PDUMP_FLAGS_CONTINUOUS) != 0))
		{
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_11)
...
Exit:
	__DtTestPoint(__DtFunc_SGXScheduleCCBCommand, __DtStep_12)
	return eError;
}
									 ...
									 IMG_BOOL				bLastInScene)
{
	...
	__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_0)
	PDUMPSUSPEND();
	...
	if (eError == PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_1)
		psDeviceNode->bReProcessDeviceCommandComplete = IMG_FALSE;
	}
	else
	{
		__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_2)
		if (eError == PVRSRV_ERROR_RETRY)
		{
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_3)
			if (ui32CallerID == ISR_ID)
			{
				


				__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_4)
				psDeviceNode->bReProcessDeviceCommandComplete = IMG_TRUE;
				eError = PVRSRV_OK;
			}
			else
			{
				...
				__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_5)
			}
		}
		else
		{
			__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_6)
			PVR_DPF((PVR_DBG_ERROR,"SGXScheduleCCBCommandKM failed to acquire lock - "
					 "ui32CallerID:%d eError:%u", ui32CallerID, eError));
		}

		__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_7)
		return eError;
	}
	...
	if (ui32CallerID != ISR_ID)
	{
		...
		__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_8)
		SGXTestActivePowerEvent(psDeviceNode, ui32CallerID);
	}

	__DtTestPoint(__DtFunc_SGXScheduleCCBCommandKM, __DtStep_9)
	return eError;
}
...
PVRSRV_ERROR SGXScheduleProcessQueuesKM(PVRSRV_DEVICE_NODE *psDeviceNode)
{
	...
	__DtTestPoint(__DtFunc_SGXScheduleProcessQueuesKM, __DtStep_0)
	ui32PowerStatus = psHostCtl->ui32PowerStatus;
	if ((ui32PowerStatus & PVRSRV_USSE_EDM_POWMAN_NO_WORK) != 0)
	{
		
		__DtTestPoint(__DtFunc_SGXScheduleProcessQueuesKM, __DtStep_1)
		return PVRSRV_OK;
	}
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXScheduleProcessQueuesKM, __DtStep_2)
		PVR_DPF((PVR_DBG_ERROR,"SGXScheduleProcessQueuesKM failed to schedule CCB command: %u", eError));
		__DtTestPoint(__DtFunc_SGXScheduleProcessQueuesKM, __DtStep_3)
		return eError;
	}

	__DtTestPoint(__DtFunc_SGXScheduleProcessQueuesKM, __DtStep_4)
	return PVRSRV_OK;
}
...
{
	__DtTestPoint(__DtFunc_SGXIsDevicePowered, __DtStep_0)
									...
									SGX_INTERNAL_DEVINFO *psSGXInternalDevInfo)
{
	...
	__DtTestPoint(__DtFunc_SGXGetInternalDevInfoKM, __DtStep_0)
	...
	__DtTestPoint(__DtFunc_SGXGetInternalDevInfoKM, __DtStep_1)
	return PVRSRV_OK;
}
						   ...
						   IMG_UINT32			ui32CleanupType)
{
	...
	__DtTestPoint(__DtFunc_SGXCleanupRequest, __DtStep_0)
	if ((psSGXHostCtl->ui32PowerStatus & PVRSRV_USSE_EDM_POWMAN_NO_WORK) != 0)
	{
		
		__DtTestPoint(__DtFunc_SGXCleanupRequest, __DtStep_1)
	}
	else
	{
		SGXMKIF_COMMAND		sCommand = {0};

		__DtTestPoint(__DtFunc_SGXCleanupRequest, __DtStep_2)
		...
		if (eError != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_SGXCleanupRequest, __DtStep_3)
		...
		if(PollForValueKM(&psSGXHostCtl->ui32CleanupStatus,
						  ...
						  IMG_TRUE) != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_SGXCleanupRequest, __DtStep_4)
	...
	__DtTestPoint(__DtFunc_SGXCleanupRequest, __DtStep_5)
}
													  ...
													  IMG_UINT32	ui32Param)
{
	...
	__DtTestPoint(__DtFunc_SGXCleanupHWRenderContextCallback, __DtStep_0)
	...
	__DtTestPoint(__DtFunc_SGXCleanupHWRenderContextCallback, __DtStep_1)
	return PVRSRV_OK;
}
														...
														IMG_UINT32	ui32Param)
{
	...
	__DtTestPoint(__DtFunc_SGXCleanupHWTransferContextCallback, __DtStep_0)
	PVR_UNREFERENCED_PARAMETER(ui32Param);
	...
	__DtTestPoint(__DtFunc_SGXCleanupHWTransferContextCallback, __DtStep_1)
	return PVRSRV_OK;
}
										...
										PVRSRV_PER_PROCESS_DATA *psPerProc)
{
	...
	__DtTestPoint(__DtFunc_SGXRegisterHWRenderContextKM, __DtStep_0)
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXRegisterHWRenderContextKM, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "SGXRegisterHWRenderContextKM: Couldn't allocate memory for SGX_HW_RENDER_CONTEXT_CLEANUP structure"));
		__DtTestPoint(__DtFunc_SGXRegisterHWRenderContextKM, __DtStep_2)
		return IMG_NULL;
	}
	...
	{
		__DtTestPoint(__DtFunc_SGXRegisterHWRenderContextKM, __DtStep_3)
		...
		__DtTestPoint(__DtFunc_SGXRegisterHWRenderContextKM, __DtStep_4)
		return IMG_NULL;
	}

	psCleanup->psResItem = psResItem;

	__DtTestPoint(__DtFunc_SGXRegisterHWRenderContextKM, __DtStep_5)
...
PVRSRV_ERROR SGXUnregisterHWRenderContextKM(IMG_HANDLE hHWRenderContext)
{
	...
	__DtTestPoint(__DtFunc_SGXUnregisterHWRenderContextKM, __DtStep_0)
	...
	{
		__DtTestPoint(__DtFunc_SGXUnregisterHWRenderContextKM, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "SGXUnregisterHWRenderContextKM: invalid parameter"));
		__DtTestPoint(__DtFunc_SGXUnregisterHWRenderContextKM, __DtStep_2)
		return PVRSRV_ERROR_INVALID_PARAMS;
	}

	eError = ResManFreeResByPtr(psCleanup->psResItem);

	__DtTestPoint(__DtFunc_SGXUnregisterHWRenderContextKM, __DtStep_3)
	return eError;
}
										  ...
										  PVRSRV_PER_PROCESS_DATA	*psPerProc)
{
	...
	__DtTestPoint(__DtFunc_SGXRegisterHWTransferContextKM, __DtStep_0)
	eError = OSAllocMem(PVRSRV_OS_PAGEABLE_HEAP,
						sizeof(SGX_HW_TRANSFER_CONTEXT_CLEANUP),
						(IMG_VOID **)&psCleanup,
						&hBlockAlloc,
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXRegisterHWTransferContextKM, __DtStep_1)
		...
		__DtTestPoint(__DtFunc_SGXRegisterHWTransferContextKM, __DtStep_2)
		return IMG_NULL;
	}
	...
	if (psResItem == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXRegisterHWTransferContextKM, __DtStep_3)
		...
		__DtTestPoint(__DtFunc_SGXRegisterHWTransferContextKM, __DtStep_4)
		return IMG_NULL;
	}

	psCleanup->psResItem = psResItem;

	__DtTestPoint(__DtFunc_SGXRegisterHWTransferContextKM, __DtStep_5)
	return (IMG_HANDLE)psCleanup;
}
...
PVRSRV_ERROR SGXUnregisterHWTransferContextKM(IMG_HANDLE hHWTransferContext)
{
	...
	__DtTestPoint(__DtFunc_SGXUnregisterHWTransferContextKM, __DtStep_0)
	...
	if (psCleanup == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXUnregisterHWTransferContextKM, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "SGXUnregisterHWTransferContextKM: invalid parameter"));
		__DtTestPoint(__DtFunc_SGXUnregisterHWTransferContextKM, __DtStep_2)
		return PVRSRV_ERROR_INVALID_PARAMS;
	}

	eError = ResManFreeResByPtr(psCleanup->psResItem);

	__DtTestPoint(__DtFunc_SGXUnregisterHWTransferContextKM, __DtStep_3)
	return eError;
}
...
static PVRSRV_ERROR SGXCleanupHW2DContextCallback(IMG_PVOID pvParam, IMG_UINT32 ui32Param)
{
	...
	__DtTestPoint(__DtFunc_SGXCleanupHW2DContextCallback, __DtStep_0)
	PVR_UNREFERENCED_PARAMETER(ui32Param);
	...
	__DtTestPoint(__DtFunc_SGXCleanupHW2DContextCallback, __DtStep_1)
	return PVRSRV_OK;
}
									...
									PVRSRV_PER_PROCESS_DATA *psPerProc)
{
	...
	__DtTestPoint(__DtFunc_SGXRegisterHW2DContextKM, __DtStep_0)
	eError = OSAllocMem(PVRSRV_OS_PAGEABLE_HEAP,
						sizeof(SGX_HW_2D_CONTEXT_CLEANUP),
						(IMG_VOID **)&psCleanup,
						&hBlockAlloc,
	...
	if (eError != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXRegisterHW2DContextKM, __DtStep_1)
		PVR_DPF((PVR_DBG_ERROR, "SGXRegisterHW2DContextKM: Couldn't allocate memory for SGX_HW_2D_CONTEXT_CLEANUP structure"));
		__DtTestPoint(__DtFunc_SGXRegisterHW2DContextKM, __DtStep_2)
		return IMG_NULL;
	}
	...
	if (psResItem == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXRegisterHW2DContextKM, __DtStep_3)
		...
		__DtTestPoint(__DtFunc_SGXRegisterHW2DContextKM, __DtStep_4)
		return IMG_NULL;
	}

	psCleanup->psResItem = psResItem;

	__DtTestPoint(__DtFunc_SGXRegisterHW2DContextKM, __DtStep_5)
	return (IMG_HANDLE)psCleanup;
}
...
PVRSRV_ERROR SGXUnregisterHW2DContextKM(IMG_HANDLE hHW2DContext)
{
	...
	__DtTestPoint(__DtFunc_SGXUnregisterHW2DContextKM, __DtStep_0)
	PVR_ASSERT(hHW2DContext != IMG_NULL);

	if (hHW2DContext == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXUnregisterHW2DContextKM, __DtStep_1)
		return (PVRSRV_ERROR_INVALID_PARAMS);
	}
	...
	__DtTestPoint(__DtFunc_SGXUnregisterHW2DContextKM, __DtStep_2)
	return eError;
}
#endif 
								   ...
								   IMG_UINT32				ui32WriteOpsPending)
{
	...
	__DtTestPoint(__DtFunc_SGX2DQuerySyncOpsComplete, __DtStep_0)
	return (IMG_BOOL)(
									   ...
									   IMG_BOOL bWaitForComplete)
{
	...
	__DtTestPoint(__DtFunc_SGX2DQueryBlitsCompleteKM, __DtStep_0)
	...
	if(SGX2DQuerySyncOpsComplete(psSyncInfo, ui32ReadOpsPending, ui32WriteOpsPending))
	{
		...
		__DtTestPoint(__DtFunc_SGX2DQueryBlitsCompleteKM, __DtStep_1)
		PVR_DPF((PVR_DBG_CALLTRACE, "SGX2DQueryBlitsCompleteKM: No wait. Blits complete."));
		__DtTestPoint(__DtFunc_SGX2DQueryBlitsCompleteKM, __DtStep_2)
		return PVRSRV_OK;
	}
	...
	if (!bWaitForComplete)
	{
		...
		__DtTestPoint(__DtFunc_SGX2DQueryBlitsCompleteKM, __DtStep_3)
		PVR_DPF((PVR_DBG_CALLTRACE, "SGX2DQueryBlitsCompleteKM: No wait. Ops pending."));
		__DtTestPoint(__DtFunc_SGX2DQueryBlitsCompleteKM, __DtStep_4)
	...
	LOOP_UNTIL_TIMEOUT(MAX_HW_TIME_US)
	{
		...
		if(SGX2DQuerySyncOpsComplete(psSyncInfo, ui32ReadOpsPending, ui32WriteOpsPending))
		{
			...
			__DtTestPoint(__DtFunc_SGX2DQueryBlitsCompleteKM, __DtStep_5)
			PVR_DPF((PVR_DBG_CALLTRACE, "SGX2DQueryBlitsCompleteKM: Wait over.  Blits complete."));
			__DtTestPoint(__DtFunc_SGX2DQueryBlitsCompleteKM, __DtStep_6)
			return PVRSRV_OK;
		}
...
{
	__DtTestPoint(__DtFunc_SGXFlushHWRenderTargetKM, __DtStep_0)
	PVR_ASSERT(sHWRTDataSetDevVAddr.uiAddr != IMG_NULL);

	SGXCleanupRequest(psDeviceNode,
					  &sHWRTDataSetDevVAddr,
					  PVRSRV_CLEANUPCMD_RT);
	__DtTestPoint(__DtFunc_SGXFlushHWRenderTargetKM, __DtStep_1)
}
							   ...
							   IMG_UINT32			ui32Time)
{
	...
	__DtTestPoint(__DtFunc_SGXConvertTimeStamp, __DtStep_0)
	return ui32Time;
#else
	...
	__DtTestPoint(__DtFunc_SGXConvertTimeStamp, __DtStep_1)
