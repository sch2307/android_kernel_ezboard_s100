#include	"DT_sgxreset.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
								  ...
								  IMG_BOOL				bPDump)
{
	...
	if (bResetBIF)
	{
		__DtTestPoint(__DtFunc_SGXResetSoftReset, __DtStep_0)
	...
	if (bPDump)
	{
		__DtTestPoint(__DtFunc_SGXResetSoftReset, __DtStep_1)
	...
	if (bResetBIF)
	{
		__DtTestPoint(__DtFunc_SGXResetSoftReset, __DtStep_2)
	...
	if (bPDump)
	{
		__DtTestPoint(__DtFunc_SGXResetSoftReset, __DtStep_3)
		PDUMPREGWITHFLAGS(SGX_PDUMPREG_NAME, EUR_CR_SOFT_RESET, ui32SoftResetRegVal, ui32PDUMPFlags);
	}
	__DtTestPoint(__DtFunc_SGXResetSoftReset, __DtStep_4)
}
							  ...
							  IMG_BOOL				bPDump)
{
	...
	if (bPDump)
	{
		__DtTestPoint(__DtFunc_SGXResetSleep, __DtStep_0)
	...
	__DtTestPoint(__DtFunc_SGXResetSleep, __DtStep_1)
}
								...
								IMG_BOOL			bPDump)
{
	...
	if (bPDump)
	{
		__DtTestPoint(__DtFunc_SGXResetInvalDC, __DtStep_0)
	...
	if (bPDump)
	{
		__DtTestPoint(__DtFunc_SGXResetInvalDC, __DtStep_1)
	...
	if (bPDump)
	{
		__DtTestPoint(__DtFunc_SGXResetInvalDC, __DtStep_2)
		PDUMPREGWITHFLAGS(SGX_PDUMPREG_NAME, EUR_CR_BIF_CTRL, ui32RegVal, ui32PDUMPFlags);
	}
#endif
...
#if !defined(SGX_FEATURE_MULTIPLE_MEM_CONTEXTS)
	{
		...
		if (PollForValueKM((IMG_UINT32 *)((IMG_UINT8*)psDevInfo->pvRegsBaseKM + EUR_CR_BIF_MEM_REQ_STAT),
							...
							IMG_FALSE) != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_SGXResetInvalDC, __DtStep_3)
				  ...
				  IMG_UINT32			ui32PDUMPFlags)
{
	...
	if (ui32RegVal & ui32BifFaultMask)
	{
		...
		__DtTestPoint(__DtFunc_SGXReset, __DtStep_0)
...
#if defined(SGX_FEATURE_MULTIPLE_MEM_CONTEXTS)
	{
		...
		for (ui32DirList = 1;
			 ...
			 ui32DirList++)
		{
			__DtTestPoint(__DtFunc_SGXReset, __DtStep_1)
	...
	if (bHardwareRecovery)
	{
		...
		__DtTestPoint(__DtFunc_SGXReset, __DtStep_2)
		...
		for (;;)
		{
			...
			__DtTestPoint(__DtFunc_SGXReset, __DtStep_3)
			if ((ui32BifIntStat & ui32BifFaultMask) == 0)
			{
				__DtTestPoint(__DtFunc_SGXReset, __DtStep_4)
				break;
			}
	...
	else
	{
		...
		__DtTestPoint(__DtFunc_SGXReset, __DtStep_5)
		SGXResetSoftReset(psDevInfo, IMG_FALSE, ui32PDUMPFlags, IMG_TRUE);
		SGXResetSleep(psDevInfo, ui32PDUMPFlags, IMG_FALSE);
	}	
	...
	__DtTestPoint(__DtFunc_SGXReset, __DtStep_6)
}
