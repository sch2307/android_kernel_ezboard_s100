#include	"DT_pb.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
					  ...
					  IMG_UINT32				*ui32SharedPBDescSubKernelMemInfosCount)
{
	...
	__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_0)
	...
	if (psStubPBDesc != IMG_NULL)
	{
		...
		__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_1)
		if(psStubPBDesc->ui32TotalPBSize != ui32TotalPBSize)
		{
			__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_2)
		...
		{
			__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_3)
		...
		{
			__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_4)
		...
		*pppsSharedPBDescSubKernelMemInfos = ppsSharedPBDescSubKernelMemInfos;
		...
		{
			__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_5)
		...
		*phSharedPBDesc = (IMG_HANDLE)psResItem;
		__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_6)
		return PVRSRV_OK;
	}
	...
	if (bLockOnFailure)
	{
		__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_7)
		if (psResItemCreateSharedPB == IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_8)
			...
			if (psResItemCreateSharedPB == IMG_NULL)
			{
				__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_9)
				PVR_DPF((PVR_DBG_ERROR, "SGXFindSharedPBDescKM: ResManRegisterRes failed"));
		...
		{
			 __DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_10)
...
ExitNotFound:
	*phSharedPBDesc = IMG_NULL;
	...
	__DtTestPoint(__DtFunc_SGXFindSharedPBDescKM, __DtStep_11)
	return eError;
}
...
SGXCleanupSharedPBDescKM(PVRSRV_STUB_PBDESC *psStubPBDescIn)
{
	...
	__DtTestPoint(__DtFunc_SGXCleanupSharedPBDescKM, __DtStep_0)
	...
	{
		__DtTestPoint(__DtFunc_SGXCleanupSharedPBDescKM, __DtStep_1)
		List_PVRSRV_STUB_PBDESC_Remove(psStubPBDescIn);
		for(i=0 ; i<psStubPBDescIn->ui32SubKernelMemInfosCount; i++)
		{
			
			__DtTestPoint(__DtFunc_SGXCleanupSharedPBDescKM, __DtStep_2)
	...
	__DtTestPoint(__DtFunc_SGXCleanupSharedPBDescKM, __DtStep_3)
	return PVRSRV_OK;
...
static PVRSRV_ERROR SGXCleanupSharedPBDescCallback(IMG_PVOID pvParam, IMG_UINT32 ui32Param)
{
	...
	__DtTestPoint(__DtFunc_SGXCleanupSharedPBDescCallback, __DtStep_0)
	PVR_UNREFERENCED_PARAMETER(ui32Param);

	__DtTestPoint(__DtFunc_SGXCleanupSharedPBDescCallback, __DtStep_1)
...
static PVRSRV_ERROR SGXCleanupSharedPBDescCreateLockCallback(IMG_PVOID pvParam, IMG_UINT32 ui32Param)
{
	...
	__DtTestPoint(__DtFunc_SGXCleanupSharedPBDescCreateLockCallback, __DtStep_0)
	return PVRSRV_OK;
}
...
{
	__DtTestPoint(__DtFunc_SGXUnrefSharedPBDescKM, __DtStep_0)
	PVR_ASSERT(hSharedPBDesc != IMG_NULL);

	__DtTestPoint(__DtFunc_SGXUnrefSharedPBDescKM, __DtStep_1)
					 ...
					 IMG_UINT32					ui32SharedPBDescSubKernelMemInfosCount)
{
	...
	__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_0)
	if (psPerProcCreateSharedPB != psPerProc)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_1)
		goto NoAdd;
	}
	else
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_2)
	...
	if (psStubPBDesc != IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_3)
		if(psStubPBDesc->ui32TotalPBSize != ui32TotalPBSize)
		{
			__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_4)
			PVR_DPF((PVR_DBG_WARNING,
		...
		if (psResItem == IMG_NULL)
		{
			__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_5)
	...
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_6)
	...
	if(OSAllocMem(PVRSRV_OS_NON_PAGEABLE_HEAP,
				  ...
				  * ui32SharedPBDescSubKernelMemInfosCount,
				  ...
				  "Array of Kernel Memory Info") != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_7)
	...
	if(PVRSRVDissociateMemFromResmanKM(psSharedPBDescKernelMemInfo)
	   != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_8)
		goto NoAdd;
	}
	...
	if(PVRSRVDissociateMemFromResmanKM(psHWPBDescKernelMemInfo)
	   != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_9)
		goto NoAdd;
	}
	...
	if(PVRSRVDissociateMemFromResmanKM(psBlockKernelMemInfo)
	   != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_10)
		goto NoAdd;
	}
	...
	if(PVRSRVDissociateMemFromResmanKM(psHWBlockKernelMemInfo)
	   != PVRSRV_OK)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_11)
		goto NoAdd;
	}
	...
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_12)
		...
		if(PVRSRVDissociateMemFromResmanKM(ppsSharedPBDescSubKernelMemInfos[i])
		   != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_13)
			PVR_DPF((PVR_DBG_ERROR, "SGXAddSharedPBDescKM: "
	...
	if (psResItem == IMG_NULL)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_14)
		PVR_DPF((PVR_DBG_ERROR, "SGXAddSharedPBDescKM: "
	...
	*phSharedPBDesc = (IMG_HANDLE)psResItem;
	...
	__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_15)
	return PVRSRV_OK;

NoAdd:
	if(psStubPBDesc)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_16)
		if(psStubPBDesc->ppsSubKernelMemInfos)
		{
			__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_17)
			OSFreeMem(PVRSRV_OS_NON_PAGEABLE_HEAP,
...
NoAddKeepPB:
	for (i = 0; i < ui32SharedPBDescSubKernelMemInfosCount; i++)
	{
		__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_18)
	...
	__DtTestPoint(__DtFunc_SGXAddSharedPBDescKM, __DtStep_19)
	return eRet;
}
