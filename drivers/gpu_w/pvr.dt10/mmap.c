#include	"DT_mmap.h"	/* For DynamicTracer-TestPoint */
/**********************************************************************
 *
...
PFNIsPhysical(IMG_UINT32 pfn)
{
	...
	__DtTestPoint(__DtFunc_PFNIsPhysical, __DtStep_0)
...
PFNIsSpecial(IMG_UINT32 pfn)
{
	...
	__DtTestPoint(__DtFunc_PFNIsSpecial, __DtStep_0)
...
{
	__DtTestPoint(__DtFunc_MMapOffsetToHandle, __DtStep_0)
	if (PFNIsPhysical(pfn))
	{
		__DtTestPoint(__DtFunc_MMapOffsetToHandle, __DtStep_1)
		PVR_ASSERT(PFNIsPhysical(pfn));
		__DtTestPoint(__DtFunc_MMapOffsetToHandle, __DtStep_2)
		return IMG_NULL;
	}
	__DtTestPoint(__DtFunc_MMapOffsetToHandle, __DtStep_3)
...
HandleToMMapOffset(IMG_HANDLE hHandle)
{
	...
	{
		__DtTestPoint(__DtFunc_HandleToMMapOffset, __DtStep_0)
		PVR_ASSERT(PFNIsSpecial(ulHandle));
		__DtTestPoint(__DtFunc_HandleToMMapOffset, __DtStep_1)
		return 0;
	}
#endif
...
{
    __DtTestPoint(__DtFunc_LinuxMemAreaUsesPhysicalMap, __DtStep_0)
...
GetCurrentThreadID(IMG_VOID)
{
	...
	__DtTestPoint(__DtFunc_GetCurrentThreadID, __DtStep_0)
...
CreateOffsetStruct(LinuxMemArea *psLinuxMemArea, IMG_UINT32 ui32Offset, IMG_UINT32 ui32RealByteSize)
{
    ...
    {
        __DtTestPoint(__DtFunc_CreateOffsetStruct, __DtStep_0)
        PVR_DPF((PVR_DBG_ERROR,"PVRMMapRegisterArea: Couldn't alloc another mapping record from cache"));
        __DtTestPoint(__DtFunc_CreateOffsetStruct, __DtStep_1)
        return IMG_NULL;
    }
    ...
    __DtTestPoint(__DtFunc_CreateOffsetStruct, __DtStep_2)
...
DestroyOffsetStruct(PKV_OFFSET_STRUCT psOffsetStruct)
{
    ...
    {
        __DtTestPoint(__DtFunc_DestroyOffsetStruct, __DtStep_0)
	...
	__DtTestPoint(__DtFunc_DestroyOffsetStruct, __DtStep_1)
}
                               ...
                               IMG_UINT32 *pui32ByteOffset)
{
    ...
    __DtTestPoint(__DtFunc_DetermineUsersSizeAndByteOffset, __DtStep_0)
    ...
    *pui32RealByteSize = PAGE_ALIGN(psLinuxMemArea->ui32ByteSize + ui32PageAlignmentOffset);
	__DtTestPoint(__DtFunc_DetermineUsersSizeAndByteOffset, __DtStep_1)
}
				...
				IMG_UINT32 *pui32UserVAddr)
{
    ...
    __DtTestPoint(__DtFunc_PVRMMapOSMemHandleToMMapData, __DtStep_0)
    ...
    if (eError != PVRSRV_OK)
    {
	__DtTestPoint(__DtFunc_PVRMMapOSMemHandleToMMapData, __DtStep_1)
    ...
    list_for_each_entry(psOffsetStruct, &psLinuxMemArea->sMMapOffsetStructList, sAreaItem)
    {
	   ...
	   __DtTestPoint(__DtFunc_PVRMMapOSMemHandleToMMapData, __DtStep_2)
    ...
    *pui32UserVAddr = 0;
    ...
    {
        __DtTestPoint(__DtFunc_PVRMMapOSMemHandleToMMapData, __DtStep_3)
    ...
    if (psOffsetStruct == IMG_NULL)
    {
        __DtTestPoint(__DtFunc_PVRMMapOSMemHandleToMMapData, __DtStep_4)
...
exit_unlock:
    ...
    __DtTestPoint(__DtFunc_PVRMMapOSMemHandleToMMapData, __DtStep_5)
    return eError;
}
                                ...
                                IMG_UINT32 *pui32UserVAddr)
{
    ...
    __DtTestPoint(__DtFunc_PVRMMapReleaseMMapData, __DtStep_0)
    LinuxLockMutex(&g_sMMapMutex);
    ...
    if (eError != PVRSRV_OK)
    {
	__DtTestPoint(__DtFunc_PVRMMapReleaseMMapData, __DtStep_1)
	PVR_DPF((PVR_DBG_ERROR, "%s: Lookup of handle %p failed", __FUNCTION__, hMHandle));
    ...
    list_for_each_entry(psOffsetStruct, &psLinuxMemArea->sMMapOffsetStructList, sAreaItem)
    {
        ...
        {
	    __DtTestPoint(__DtFunc_PVRMMapReleaseMMapData, __DtStep_2)
	    if (psOffsetStruct->ui32RefCount == 0)
	    {
		__DtTestPoint(__DtFunc_PVRMMapReleaseMMapData, __DtStep_3)
...
exit_unlock:
    ...
    __DtTestPoint(__DtFunc_PVRMMapReleaseMMapData, __DtStep_4)
    return eError;
}
...
#endif
	    {
	        __DtTestPoint(__DtFunc_FindOffsetStructByOffset, __DtStep_0)
	        return psOffsetStruct;
	    }
        }
    }

    __DtTestPoint(__DtFunc_FindOffsetStructByOffset, __DtStep_1)
    return IMG_NULL;
}
            ...
            IMG_UINT32 ui32ByteOffset)
{
    ...
    __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_0)
    if (psLinuxMemArea->eAreaType == LINUX_MEM_AREA_SUB_ALLOC)
    {
        __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_1)
...
#error "SPARC not supported"
	...
	__DtTestPoint(__DtFunc_DoMapToUser, __DtStep_2)
	...
	result = IO_REMAP_PFN_RANGE(ps_vma, ps_vma->vm_start, ps_vma->vm_pgoff, ui32ByteSize, ps_vma->vm_page_prot);
        ...
        if(result == 0)
        {
            __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_3)
            return IMG_TRUE;
        }
	...
	for(ui32PA = ui32ByteOffset; ui32PA < ui32ByteEnd; ui32PA += PAGE_SIZE)
	{
	    ...
	    __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_4)
	    if (!pfn_valid(pfn))
	    {
#if !defined(PVR_MAKE_ALL_PFNS_SPECIAL)
                PVR_DPF((PVR_DBG_ERROR,"%s: Error - PFN invalid: 0x%x", __FUNCTION__, pfn));
                __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_5)
                return IMG_FALSE;
#else
		bMixedMap = IMG_TRUE;
#endif
	...
	if (bMixedMap)
	{
            __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_6)
	...
	for(ui32PA = ui32ByteOffset; ui32PA < ui32ByteEnd; ui32PA += PAGE_SIZE)
	{
	    ...
	    __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_7)
	    pfn =  LinuxMemAreaToCpuPFN(psLinuxMemArea, ui32PA);

#if defined(PVR_MAKE_ALL_PFNS_SPECIAL)
	    if (bMixedMap)
	    {
		__DtTestPoint(__DtFunc_DoMapToUser, __DtStep_8)
		result = vm_insert_mixed(ps_vma, ulVMAPos, pfn);
                if(result != 0)
                {
                    __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_9)
                    PVR_DPF((PVR_DBG_ERROR,"%s: Error - vm_insert_mixed failed (%d)", __FUNCTION__, result));
                    __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_10)
                    return IMG_FALSE;
                }
	    }
	    else
		...
		struct page *psPage;
	        ...
	        result = VM_INSERT_PAGE(ps_vma,  ulVMAPos, psPage);
                if(result != 0)
                {
                    __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_11)
                    PVR_DPF((PVR_DBG_ERROR,"%s: Error - VM_INSERT_PAGE failed (%d)", __FUNCTION__, result));
                    __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_12)
                    return IMG_FALSE;
                }
	    }
            ulVMAPos += PAGE_SIZE;
    ...
    __DtTestPoint(__DtFunc_DoMapToUser, __DtStep_13)
    return IMG_TRUE;
}
...
MMapVOpenNoLock(struct vm_area_struct* ps_vma)
{
    ...
    __DtTestPoint(__DtFunc_MMapVOpenNoLock, __DtStep_0)
    ...
    {
	__DtTestPoint(__DtFunc_MMapVOpenNoLock, __DtStep_1)
    ...
    MOD_INC_USE_COUNT;
#endif
	__DtTestPoint(__DtFunc_MMapVOpenNoLock, __DtStep_2)
}
...
{
    __DtTestPoint(__DtFunc_MMapVOpen, __DtStep_0)
    LinuxLockMutex(&g_sMMapMutex);

    MMapVOpenNoLock(ps_vma);

    LinuxUnLockMutex(&g_sMMapMutex);
	__DtTestPoint(__DtFunc_MMapVOpen, __DtStep_1)
}
...
{
    PKV_OFFSET_STRUCT psOffsetStruct = (PKV_OFFSET_STRUCT)ps_vma->vm_private_data;
    __DtTestPoint(__DtFunc_MMapVCloseNoLock, __DtStep_0)
    PVR_ASSERT(psOffsetStruct != IMG_NULL)
    ...
    {
	__DtTestPoint(__DtFunc_MMapVCloseNoLock, __DtStep_1)
	if (psOffsetStruct->ui32RefCount != 0)
	{
	        __DtTestPoint(__DtFunc_MMapVCloseNoLock, __DtStep_2)
    ...
    MOD_DEC_USE_COUNT;
#endif
	__DtTestPoint(__DtFunc_MMapVCloseNoLock, __DtStep_3)
}

static void
MMapVClose(struct vm_area_struct* ps_vma)
{
    __DtTestPoint(__DtFunc_MMapVClose, __DtStep_0)
    LinuxLockMutex(&g_sMMapMutex);

    MMapVCloseNoLock(ps_vma);

    LinuxUnLockMutex(&g_sMMapMutex);
	__DtTestPoint(__DtFunc_MMapVClose, __DtStep_1)
}
...
PVRMMap(struct file* pFile, struct vm_area_struct* ps_vma)
{
    ...
    __DtTestPoint(__DtFunc_PVRMMap, __DtStep_0)
    ...
    {
        __DtTestPoint(__DtFunc_PVRMMap, __DtStep_1)
    ...
    switch(psOffsetStruct->psLinuxMemArea->ui32AreaFlags & PVRSRV_HAP_CACHETYPE_MASK)
    {
        case PVRSRV_HAP_CACHED:
            ...
            __DtTestPoint(__DtFunc_PVRMMap, __DtStep_2)
            break;
        case PVRSRV_HAP_WRITECOMBINE:
	    __DtTestPoint(__DtFunc_PVRMMap, __DtStep_3)
	    ps_vma->vm_page_prot = PGPROT_WC(ps_vma->vm_page_prot);
            break;
        case PVRSRV_HAP_UNCACHED:
            __DtTestPoint(__DtFunc_PVRMMap, __DtStep_4)
            ps_vma->vm_page_prot = PGPROT_UC(ps_vma->vm_page_prot);
            break;
        default:
            __DtTestPoint(__DtFunc_PVRMMap, __DtStep_5)
    ...
    {
        __DtTestPoint(__DtFunc_PVRMMap, __DtStep_6)
        iRetVal = -EAGAIN;
        goto unlock_and_return;
    }
    ...
    if(psOffsetStruct->psLinuxMemArea->bNeedsCacheInvalidate)
    {
        ...
        __DtTestPoint(__DtFunc_PVRMMap, __DtStep_7)
...
unlock_and_return:
    ...
    {
	__DtTestPoint(__DtFunc_PVRMMap, __DtStep_8)
	DestroyOffsetStruct(psOffsetStruct);
    }

    LinuxUnLockMutex(&g_sMMapMutex);
    
    __DtTestPoint(__DtFunc_PVRMMap, __DtStep_9)
    return iRetVal;
}
...
{
	__DtTestPoint(__DtFunc_ProcSeqStartstopMMapRegistations, __DtStep_0)
	if(start) 
	{
	    __DtTestPoint(__DtFunc_ProcSeqStartstopMMapRegistations, __DtStep_1)
	    LinuxLockMutex(&g_sMMapMutex);		
	}
	else
	{
	    __DtTestPoint(__DtFunc_ProcSeqStartstopMMapRegistations, __DtStep_2)
	    LinuxUnLockMutex(&g_sMMapMutex);
	}
	__DtTestPoint(__DtFunc_ProcSeqStartstopMMapRegistations, __DtStep_3)
}
...
{
    LinuxMemArea *psLinuxMemArea;
	__DtTestPoint(__DtFunc_ProcSeqOff2ElementMMapRegistrations, __DtStep_0)
	if(!off) 
	{
		__DtTestPoint(__DtFunc_ProcSeqOff2ElementMMapRegistrations, __DtStep_1)
    ...
    list_for_each_entry(psLinuxMemArea, &g_sMMapAreaList, sMMapItem)
    {
	 	...
	 	list_for_each_entry(psOffsetStruct, &psLinuxMemArea->sMMapOffsetStructList, sAreaItem)
        {
	    	...
	    	if (off == 0)
	    	{				
				__DtTestPoint(__DtFunc_ProcSeqOff2ElementMMapRegistrations, __DtStep_2)
				PVR_ASSERT(psOffsetStruct->psLinuxMemArea == psLinuxMemArea);
				__DtTestPoint(__DtFunc_ProcSeqOff2ElementMMapRegistrations, __DtStep_3)
				return (void*)psOffsetStruct;
		    }
        }
    }
	__DtTestPoint(__DtFunc_ProcSeqOff2ElementMMapRegistrations, __DtStep_4)
	return (void*)0;
}

static void* ProcSeqNextMMapRegistrations(struct seq_file *sfile,void* el,loff_t off)
{
	__DtTestPoint(__DtFunc_ProcSeqNextMMapRegistrations, __DtStep_0)
...
static void ProcSeqShowMMapRegistrations(struct seq_file *sfile, void *el)
{
	...
	__DtTestPoint(__DtFunc_ProcSeqShowMMapRegistrations, __DtStep_0)
	if(el == PVR_PROC_SEQ_START_TOKEN) 
	{
        __DtTestPoint(__DtFunc_ProcSeqShowMMapRegistrations, __DtStep_1)
        seq_printf( sfile,
		...
		__DtTestPoint(__DtFunc_ProcSeqShowMMapRegistrations, __DtStep_2)
		return;
	}
	...
	__DtTestPoint(__DtFunc_ProcSeqShowMMapRegistrations, __DtStep_3)
}
...
PVRMMapRegisterArea(LinuxMemArea *psLinuxMemArea)
{
    ...
    {
        __DtTestPoint(__DtFunc_PVRMMapRegisterArea, __DtStep_0)
    ...
    if (psLinuxMemArea->eAreaType != LINUX_MEM_AREA_SUB_ALLOC)
    {
        __DtTestPoint(__DtFunc_PVRMMapRegisterArea, __DtStep_1)
...
exit_unlock:
    ...
    __DtTestPoint(__DtFunc_PVRMMapRegisterArea, __DtStep_2)
    return eError;
}
...
PVRMMapRemoveRegisteredArea(LinuxMemArea *psLinuxMemArea)
{
    ...
    __DtTestPoint(__DtFunc_PVRMMapRemoveRegisteredArea, __DtStep_0)
    LinuxLockMutex(&g_sMMapMutex);
	...
	if (psOffsetStruct->ui32Mapped != 0)
	{
	     __DtTestPoint(__DtFunc_PVRMMapRemoveRegisteredArea, __DtStep_1)
	...
	else
	{
	     ...
	     __DtTestPoint(__DtFunc_PVRMMapRemoveRegisteredArea, __DtStep_2)
    ...
    if (psLinuxMemArea->eAreaType != LINUX_MEM_AREA_SUB_ALLOC)
    {
        __DtTestPoint(__DtFunc_PVRMMapRemoveRegisteredArea, __DtStep_3)
        g_ui32TotalByteSize -= psLinuxMemArea->ui32ByteSize;
    }
#endif
...
exit_unlock:
    LinuxUnLockMutex(&g_sMMapMutex);
    __DtTestPoint(__DtFunc_PVRMMapRemoveRegisteredArea, __DtStep_4)
    return eError;
}
...
{
    __DtTestPoint(__DtFunc_LinuxMMapPerProcessConnect, __DtStep_0)
    PVR_UNREFERENCED_PARAMETER(psEnvPerProc);

    __DtTestPoint(__DtFunc_LinuxMMapPerProcessConnect, __DtStep_1)
    return PVRSRV_OK;
}
...
LinuxMMapPerProcessDisconnect(PVRSRV_ENV_PER_PROCESS_DATA *psEnvPerProc)
{
    ...
    __DtTestPoint(__DtFunc_LinuxMMapPerProcessDisconnect, __DtStep_0)
    PVR_UNREFERENCED_PARAMETER(psEnvPerProc);
	...
	if (psOffsetStruct->ui32PID == ui32PID)
	{
	    __DtTestPoint(__DtFunc_LinuxMMapPerProcessDisconnect, __DtStep_1)
	    if (!bWarn)
	    {
		__DtTestPoint(__DtFunc_LinuxMMapPerProcessDisconnect, __DtStep_2)
    ...
    LinuxUnLockMutex(&g_sMMapMutex);
	__DtTestPoint(__DtFunc_LinuxMMapPerProcessDisconnect, __DtStep_3)
}
...
PVRSRV_ERROR LinuxMMapPerProcessHandleOptions(PVRSRV_HANDLE_BASE *psHandleBase)
{
    ...
    __DtTestPoint(__DtFunc_LinuxMMapPerProcessHandleOptions, __DtStep_0)
    eError = PVRSRVSetMaxHandle(psHandleBase, MAX_MMAP_HANDLE);
    if (eError != PVRSRV_OK)
    {
	__DtTestPoint(__DtFunc_LinuxMMapPerProcessHandleOptions, __DtStep_1)
	PVR_DPF((PVR_DBG_ERROR,"%s: failed to set handle limit (%d)", __FUNCTION__, eError));
	__DtTestPoint(__DtFunc_LinuxMMapPerProcessHandleOptions, __DtStep_2)
	return eError;
    }

    __DtTestPoint(__DtFunc_LinuxMMapPerProcessHandleOptions, __DtStep_3)
    return eError;
}
...
error:
    PVRMMapCleanup();
    __DtTestPoint(__DtFunc_PVRMMapInit, __DtStep_2)
    return;
}
...
PVRMMapCleanup(IMG_VOID)
{
    ...
    __DtTestPoint(__DtFunc_PVRMMapCleanup, __DtStep_0)
    if (!list_empty(&g_sMMapAreaList))
    {
	LinuxMemArea *psLinuxMemArea, *psTmpMemArea;

	__DtTestPoint(__DtFunc_PVRMMapCleanup, __DtStep_1)
 	...
 	list_for_each_entry_safe(psLinuxMemArea, psTmpMemArea, &g_sMMapAreaList, sMMapItem)
	{
		...
		if (eError != PVRSRV_OK)
		{
			__DtTestPoint(__DtFunc_PVRMMapCleanup, __DtStep_2)
    ...
    if(g_psMemmapCache)
    {
        __DtTestPoint(__DtFunc_PVRMMapCleanup, __DtStep_3)
        KMemCacheDestroyWrapper(g_psMemmapCache);
        g_psMemmapCache = NULL;
    }
	__DtTestPoint(__DtFunc_PVRMMapCleanup, __DtStep_4)
}
